...
ffi.cdef [[
  ...
  static const UINT AVRT_PRIORITY_LOW = -1;
  static const UINT AVRT_PRIORITY_NORMAL = 0;
  static const UINT AVRT_PRIORITY_HIGH = 1;
  static const UINT AVRT_PRIORITY_CRITICAL = 2;
