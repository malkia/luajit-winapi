...
ffi.cdef [[
  ...
  static const WINAPI_IME_CAND IME_CAND_UNKNOWN = 0x0000;
  static const WINAPI_IME_CAND IME_CAND_READ = 0x0001;
  static const WINAPI_IME_CAND IME_CAND_CODE = 0x0002;
  static const WINAPI_IME_CAND IME_CAND_MEANING = 0x0003;
  static const WINAPI_IME_CAND IME_CAND_RADICAL = 0x0004;
  static const WINAPI_IME_CAND IME_CAND_STROKE = 0x0005;
  ...
  static const WINAPI_ImmNotifyAction NI_OPENCANDIDATE = 0x0010;
  static const WINAPI_ImmNotifyAction NI_CLOSECANDIDATE = 0x0011;
  static const WINAPI_ImmNotifyAction NI_SELECTCANDIDATESTR = 0x0012;
  static const WINAPI_ImmNotifyAction NI_CHANGECANDIDATELIST = 0x0013;
  static const WINAPI_ImmNotifyAction NI_FINALIZECONVERSIONRESULT = 0x0014;
  static const WINAPI_ImmNotifyAction NI_COMPOSITIONSTR = 0x0015;
  static const WINAPI_ImmNotifyAction NI_SETCANDIDATE_PAGESTART = 0x0016;
  static const WINAPI_ImmNotifyAction NI_SETCANDIDATE_PAGESIZE = 0x0017;
  static const WINAPI_ImmNotifyAction NI_IMEMENUSELECTED = 0x0018;
  typedef DWORD WINAPI_CompositionString; //Alias
  static const WINAPI_CompositionString CPS_COMPLETE = 0x0001;
  static const WINAPI_CompositionString CPS_CONVERT = 0x0002;
  static const WINAPI_CompositionString CPS_REVERT = 0x0003;
  static const WINAPI_CompositionString CPS_CANCEL = 0x0004;
  typedef DWORD WINAPI_ImmGetPropertyIndex; //Alias
  static const WINAPI_ImmGetPropertyIndex IGP_GETIMEVERSION = -4;
  static const WINAPI_ImmGetPropertyIndex IGP_PROPERTY = 0x00000004;
  static const WINAPI_ImmGetPropertyIndex IGP_CONVERSION = 0x00000008;
  static const WINAPI_ImmGetPropertyIndex IGP_SENTENCE = 0x0000000c;
  static const WINAPI_ImmGetPropertyIndex IGP_UI = 0x00000010;
  static const WINAPI_ImmGetPropertyIndex IGP_SETCOMPSTR = 0x00000014;
  static const WINAPI_ImmGetPropertyIndex IGP_SELECT = 0x00000018;
