...
# pragma pack( pop )
  ...
  WINAPI_byte_type              _mbsbtype(                                                        unsigned char* mbstr, size_t count);
  WINAPI_byte_type              _mbsbtype_l(                                                      unsigned char* mbstr, size_t count, _locale_t locale);
  int                           isalnum(                                                          int c);
  ...
  int                           _CrtCheckMemory(                                                  );
  void                          _CrtDbgBreak(                                                     );
  int                           _CrtDbgReport(                                                    WINAPI_CRT_REPORT_TYPE reportType, char* filename, int linenumber, char* moduleName, char* format);
  int                           _CrtDbgReportW(                                                   WINAPI_CRT_REPORT_TYPE reportType, wchar_t* filename, int linenumber, wchar_t* moduleName, wchar_t* format);
  ...
  char*                         _getcwd_dbg(                                                      char* buffer, int maxlen, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  wchar_t*                      _wgetcwd(                                                         wchar_t* buffer, int maxlen);
  wchar_t*                      _wgetcwd_dbg(                                                     wchar_t* buffer, int maxlen, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  char*                         _getdcwd(                                                         int drive, char* buffer, int maxlen);
  char*                         _getdcwd_dbg(                                                     int drive, char* buffer, int maxlen, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  wchar_t*                      _wgetdcwd(                                                        int drive, wchar_t* buffer, int maxlen);
  wchar_t*                      _wgetdcwd_dbg(                                                    int drive, wchar_t* buffer, int maxlen, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  ...
  int                           _chmod(                                                           char* filename, WINAPI_perm_mode pmode);
  int                           _wchmod(                                                          wchar_t* filename, WINAPI_perm_mode pmode);
  char*                         _fullpath(                                                        char* absPath, char* relPath, size_t maxLength);
  char*                         _fullpath_dbg(                                                    char* absPath, char* relPath, size_t maxLength, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  wchar_t*                      _wfullpath(                                                       wchar_t* absPath, wchar_t* relPath, size_t maxLength);
  wchar_t*                      _wfullpath_dbg(                                                   wchar_t* absPath, wchar_t* relPath, size_t maxLength, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  ...
  WINAPI_RET_EOF                fputs(                                                            char* str, FILE* stream);
  WINAPI_RET_WEOF_INT           fputws(                                                           wchar_t* str, FILE* stream);
  ...
  WINAPI_RET_EOF                fscanf(                                                           FILE* stream, char* format);
  WINAPI_RET_EOF                _fscanf_l(                                                        FILE* stream, char* format, _locale_t locale);
  WINAPI_RET_EOF                fwscanf(                                                          FILE* stream, wchar_t* format);
  WINAPI_RET_EOF                _fwscanf_l(                                                       FILE* stream, wchar_t* format, _locale_t locale);
  WINAPI_RET_EOF                fscanf_s(                                                         FILE* stream, char* format);
  WINAPI_RET_EOF                _fscanf_s_l(                                                      FILE* stream, char* format, _locale_t locale);
  WINAPI_RET_EOF                fwscanf_s(                                                        FILE* stream, wchar_t* format);
  WINAPI_RET_EOF                _fwscanf_s_l(                                                     FILE* stream, wchar_t* format, _locale_t locale);
  ...
  FILE*                         _fsopen(                                                          char* filename, char* mode, WINAPI_share_flag shflag);
  FILE*                         _wfsopen(                                                         wchar_t* filename, wchar_t* mode, WINAPI_share_flag shflag);
  ...
  WINAPI_RET_EOF                puts(                                                             char* str);
  WINAPI_RET_WEOF_INT           _putws(                                                           wchar_t* str);
  ...
  char*                         _tempnam_dbg(                                                     char* dir, char* prefix, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  wchar_t*                      _wtempnam(                                                        wchar_t* dir, wchar_t* prefix);
  wchar_t*                      _wtempnam_dbg(                                                    wchar_t* dir, wchar_t* prefix, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  ...
  WINAPI_RET_EOF                scanf(                                                            char* format);
  WINAPI_RET_EOF                _scanf_l(                                                         char* format, _locale_t locale);
  WINAPI_RET_EOF                wscanf(                                                           wchar_t* format);
  WINAPI_RET_EOF                _wscanf_l(                                                        wchar_t* format, _locale_t locale);
  WINAPI_RET_EOF                scanf_s(                                                          char* format);
  WINAPI_RET_EOF                _scanf_s_l(                                                       char* format, _locale_t locale);
  WINAPI_RET_EOF                wscanf_s(                                                         wchar_t* format);
  WINAPI_RET_EOF                _wscanf_s_l(                                                      wchar_t* format, _locale_t locale);
  ...
  int                           _close(                                                           int fd);
  int                           _commit(                                                          int fd);
  int                           _creat(                                                           char* filename, WINAPI_perm_mode pmode);
  int                           _wcreat(                                                          wchar_t* filename, WINAPI_perm_mode pmode);
  int                           _dup(                                                             int fd);
  ...
  int                           _open(                                                            char* filename, WINAPI_open_flag oflag, WINAPI_perm_mode pmode);
  int                           _wopen(                                                           wchar_t* filename, WINAPI_open_flag oflag, WINAPI_perm_mode pmode);
  int                           _read(                                                            int fd, void* buffer, unsigned int count);
  int                           _sopen(                                                           char* filename, WINAPI_open_flag oflag, WINAPI_share_flag shflag, WINAPI_perm_mode pmode);
  int                           _wsopen(                                                          wchar_t* filename, WINAPI_open_flag oflag, WINAPI_share_flag shflag, WINAPI_perm_mode pmode);
  errno_t                       _sopen_s(                                                         int* pfh, char* filename, WINAPI_open_flag oflag, WINAPI_share_flag shflag, WINAPI_perm_mode pmode);
  errno_t                       _wsopen_s(                                                        int* pfh, wchar_t* filename, WINAPI_open_flag oflag, WINAPI_share_flag shflag, WINAPI_perm_mode pmode);
  ...
  WINAPI_RET_EOF                _cscanf(                                                          char* format);
  WINAPI_RET_EOF                _cscanf_l(                                                        char* format, _locale_t locale);
  WINAPI_RET_EOF                _cwscanf(                                                         wchar_t* format);
  WINAPI_RET_EOF                _cwscanf_l(                                                       wchar_t* format, _locale_t locale);
  WINAPI_RET_EOF                _cscanf_s(                                                        char* format);
  WINAPI_RET_EOF                _cscanf_s_l(                                                      char* format, _locale_t locale);
  WINAPI_RET_EOF                _cwscanf_s(                                                       wchar_t* format);
  WINAPI_RET_EOF                _cwscanf_s_l(                                                     wchar_t* format, _locale_t locale);
  int                           _getch(                                                           );
  wint_t                        _getwch(                                                          );
  int                           _getche(                                                          );
  wint_t                        _getwche(                                                         );
  ...
  char*                         setlocale(                                                        WINAPI_locale_category category, char* locale);
  wchar_t*                      _wsetlocale(                                                      WINAPI_locale_category category, wchar_t* locale);
  _locale_t                     _create_locale(                                                   WINAPI_locale_category category, char* locale);
  _locale_t                     __create_locale(                                                  WINAPI_locale_category category, char* locale);
  ...
  void*                         _expand_dbg(                                                      void* userData, size_t newSize, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  void*                         _calloc_dbg(                                                      size_t num, size_t size, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  void                          _free_dbg(                                                        void* userData, WINAPI_DBG_BLOCK_TYPE blockType);
  void*                         _malloc_dbg(                                                      size_t size, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  size_t                        _msize_dbg(                                                       void* userData, WINAPI_DBG_BLOCK_TYPE blockType);
  void*                         _realloc_dbg(                                                     void* userData, size_t newSize, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  void*                         _recalloc(                                                        void* memblock, size_t size);
  void*                         _recalloc_dbg(                                                    void* userData, size_t num, size_t size, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  ...
  intptr_t                      _spawnl(                                                          WINAPI_spawn_mode mode, char* cmdname, char* args);
  intptr_t                      _wspawnl(                                                         WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t* args);
  intptr_t                      _spawnle(                                                         WINAPI_spawn_mode mode, char* cmdname, char* args);
  intptr_t                      _wspawnle(                                                        WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t* args);
  intptr_t                      _spawnlp(                                                         WINAPI_spawn_mode mode, char* cmdname, char* args);
  intptr_t                      _wspawnlp(                                                        WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t* args);
  intptr_t                      _spawnlpe(                                                        WINAPI_spawn_mode mode, char* cmdname, char* args);
  intptr_t                      _wspawnlpe(                                                       WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t* args);
  intptr_t                      _spawnv(                                                          WINAPI_spawn_mode mode, char* cmdname, char** argv);
  intptr_t                      _wspawnv(                                                         WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t** argv);
  intptr_t                      _spawnve(                                                         WINAPI_spawn_mode mode, char* cmdname, char** argv, char** envp);
  intptr_t                      _wspawnve(                                                        WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t** argv, wchar_t** envp);
  intptr_t                      _spawnvp(                                                         WINAPI_spawn_mode mode, char* cmdname, char** argv);
  intptr_t                      _wspawnvp(                                                        WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t** argv);
  intptr_t                      _spawnvpe(                                                        WINAPI_spawn_mode mode, char* cmdname, char** argv, char** envp);
  intptr_t                      _wspawnvpe(                                                       WINAPI_spawn_mode mode, wchar_t* cmdname, wchar_t** argv, wchar_t** envp);
  ...
  errno_t                       _dupenv_s_dbg(                                                    char** buffer, size_t* numberOfElements, char* varname, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  errno_t                       _wdupenv_s_dbg(                                                   wchar_t** buffer, size_t* numberOfElements, wchar_t* varname, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  ...
  void*                         bsearch(                                                          void* key, void* base, size_t num, size_t width, WINAPI_compare_function compare);
  void*                         bsearch_s(                                                        void* key, void* base, size_t num, size_t width, WINAPI_compare_s_function compare, void* context);
  void*                         _lfind(                                                           void* key, void* base, unsigned int* num, unsigned int width, WINAPI_compare_function compare);
  void*                         _lfind_s(                                                         void* key, void* base, unsigned int* num, size_t size, WINAPI_compare_s_function compare, void* context);
  void*                         _lsearch(                                                         void* key, void* base, unsigned int* num, unsigned int width, WINAPI_compare_function compare);
  void*                         _lsearch_s(                                                       void* key, void* base, unsigned int* num, size_t size, WINAPI_compare_s_function compare, void* context);
  ...
  WINAPI__NLSCMPERROR           _mbsnbcmp(                                                        unsigned char* string1, unsigned char* string2, size_t count);
  WINAPI__NLSCMPERROR           _mbsnbcmp_l(                                                      unsigned char* string1, unsigned char* string2, size_t count, _locale_t locale);
  ...
  WINAPI__NLSCMPERROR           _mbsnbicmp(                                                       unsigned char* string1, unsigned char* string2, size_t count);
  ...
  WINAPI_RET_EOF                _snscanf(                                                         char* input, size_t length, char* format);
  WINAPI_RET_EOF                _snscanf_l(                                                       char* input, size_t length, char* format, _locale_t locale);
  WINAPI_RET_EOF                _snwscanf(                                                        wchar_t* input, size_t length, wchar_t* format);
  WINAPI_RET_EOF                _snwscanf_l(                                                      wchar_t* input, size_t length, wchar_t* format, _locale_t locale);
  WINAPI_RET_EOF                sscanf(                                                           char* buffer, char* format);
  WINAPI_RET_EOF                _sscanf_l(                                                        char* buffer, char* format, _locale_t locale);
  WINAPI_RET_EOF                swscanf(                                                          wchar_t* buffer, wchar_t* format);
  WINAPI_RET_EOF                _swscanf_l(                                                       wchar_t* buffer, wchar_t* format, _locale_t locale);
  ...
  WINAPI__NLSCMPERROR           _mbscmp(                                                          unsigned char* string1, unsigned char* string2);
  ...
  WINAPI__NLSCMPERROR           _mbsncmp(                                                         unsigned char* string1, unsigned char* string2, size_t count);
  WINAPI__NLSCMPERROR           _mbsncmp_l(                                                       unsigned char* string1, unsigned char* string2, size_t count, _locale_t locale);
  ...
  WINAPI__NLSCMPERROR           strcoll(                                                          char* string1, char* string2);
  WINAPI__NLSCMPERROR           wcscoll(                                                          wchar_t* string1, wchar_t* string2);
  WINAPI__NLSCMPERROR           _mbscoll(                                                         unsigned char* string1, unsigned char* string2);
  WINAPI__NLSCMPERROR           _strcoll_l(                                                       char* string1, char* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _wcscoll_l(                                                       wchar_t* string1, wchar_t* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbscoll_l(                                                       unsigned char* string1, unsigned char* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _stricoll(                                                        char* string1, char* string2);
  WINAPI__NLSCMPERROR           _wcsicoll(                                                        wchar_t* string1, wchar_t* string2);
  WINAPI__NLSCMPERROR           _mbsicoll(                                                        unsigned char* string1, unsigned char* string2);
  WINAPI__NLSCMPERROR           _stricoll_l(                                                      char* string1, char* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _wcsicoll_l(                                                      wchar_t* string1, wchar_t* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbsicoll_l(                                                      unsigned char* string1, unsigned char* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _strncoll(                                                        char* string1, char* string2, size_t count);
  WINAPI__NLSCMPERROR           _wcsncoll(                                                        wchar_t* string1, wchar_t* string2, size_t count);
  WINAPI__NLSCMPERROR           _mbsncoll(                                                        unsigned char* string1, unsigned char* string2, size_t count);
  WINAPI__NLSCMPERROR           _strncoll_l(                                                      char* string1, char* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _wcsncoll_l(                                                      wchar_t* string1, wchar_t* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbsncoll_l(                                                      unsigned char* string1, unsigned char* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _strnicoll(                                                       char* string1, char* string2, size_t count);
  WINAPI__NLSCMPERROR           _wcsnicoll(                                                       wchar_t* string1, wchar_t* string2, size_t count);
  WINAPI__NLSCMPERROR           _mbsnicoll(                                                       unsigned char* string1, unsigned char* string2, size_t count);
  WINAPI__NLSCMPERROR           _strnicoll_l(                                                     char* string1, char* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _wcsnicoll_l(                                                     wchar_t* string1, wchar_t* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbsnicoll_l(                                                     unsigned char* string1, unsigned char* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _strcmpi(                                                         char* string1, char* string2);
  WINAPI__NLSCMPERROR           _stricmp(                                                         char* string1, char* string2);
  WINAPI__NLSCMPERROR           _wcsicmp(                                                         wchar_t* string1, wchar_t* string2);
  WINAPI__NLSCMPERROR           _mbsicmp(                                                         unsigned char* string1, unsigned char* string2);
  WINAPI__NLSCMPERROR           _stricmp_l(                                                       char* string1, char* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _wcsicmp_l(                                                       wchar_t* string1, wchar_t* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbsicmp_l(                                                       unsigned char* string1, unsigned char* string2, _locale_t locale);
  WINAPI__NLSCMPERROR           _wcsnicmp_l(                                                      wchar_t* string1, wchar_t* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbsnicmp_l(                                                      unsigned char* string1, unsigned char* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbsnicmp(                                                        unsigned char* string1, unsigned char* string2, size_t count);
  WINAPI__NLSCMPERROR           _strnicmp_l(                                                      char* string1, char* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _wcsnicmp(                                                        wchar_t* string1, wchar_t* string2, size_t count);
  WINAPI__NLSCMPERROR           _strnicmp(                                                        char* string1, char* string2, size_t count);
  ...
  WINAPI_RET_EOF                _snscanf_s(                                                       char* input, size_t length, char* format);
  WINAPI_RET_EOF                _snscanf_s_l(                                                     char* input, size_t length, char* format, _locale_t locale);
  WINAPI_RET_EOF                _snwscanf_s(                                                      wchar_t* input, size_t length, wchar_t* format);
  WINAPI_RET_EOF                _snwscanf_s_l(                                                    wchar_t* input, size_t length, wchar_t* format, _locale_t locale);
  ...
  WINAPI_RET_EOF                _swscanf_s_l(                                                     wchar_t* buffer, wchar_t* format, _locale_t locale);
  WINAPI_RET_EOF                swscanf_s(                                                        wchar_t* buffer, wchar_t* format);
  WINAPI_RET_EOF                _sscanf_s_l(                                                      char* buffer, char* format, _locale_t locale);
  WINAPI_RET_EOF                sscanf_s(                                                         char* buffer, char* format);
  ...
  char*                         _strdup_dbg(                                                      char* strSource, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  wchar_t*                      _wcsdup_dbg(                                                      wchar_t* strSource, WINAPI_DBG_BLOCK_TYPE blockType, char* filename, int linenumber);
  WINAPI_size_t_INT_MAX         strxfrm(                                                          char* strDest, char* strSource, size_t count);
  WINAPI_size_t_INT_MAX         wcsxfrm(                                                          wchar_t* strDest, wchar_t* strSource, size_t count);
  WINAPI_size_t_INT_MAX         _strxfrm_l(                                                       char* strDest, char* strSource, size_t count, _locale_t locale);
  WINAPI_size_t_INT_MAX         _wcsxfrm_l(                                                       wchar_t* strDest, wchar_t* strSource, size_t count, _locale_t locale);
  size_t                        mbrlen(                                                           char* str, size_t maxSize, mbstate_t mbstate);
  WINAPI__NLSCMPERROR           _mbsnbcoll(                                                       unsigned char* string1, unsigned char* string2, size_t count);
  WINAPI__NLSCMPERROR           _mbsnbcoll_l(                                                     unsigned char* string1, unsigned char* string2, size_t count, _locale_t locale);
  WINAPI__NLSCMPERROR           _mbsnbicoll(                                                      unsigned char* string1, unsigned char* string2, size_t count);
  WINAPI__NLSCMPERROR           _mbsnbicoll_l(                                                    unsigned char* string1, unsigned char* string2, size_t count, _locale_t locale);
