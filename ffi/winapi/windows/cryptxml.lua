...
ffi.cdef [[
  ...
  static const UINT CRYPT_XML_CHARSET_AUTO = 0;
  static const UINT CRYPT_XML_CHARSET_UTF8 = 1;
  static const UINT CRYPT_XML_CHARSET_UTF16LE = 2;
  static const UINT CRYPT_XML_CHARSET_UTF16BE = 3;
  typedef struct CRYPT_XML_BLOB {
    CRYPT_XML_CHARSET dwCharset;
    ULONG cbData;
    BYTE* pbData;
  } CRYPT_XML_BLOB;
  typedef CRYPT_XML_BLOB *WINAPI_PCRYPT_XML_BLOB; //Pointer
  typedef DWORD WINAPI_CRYPT_XML_KEY_VALUE_TYPE; //Alias
  static const DWORD CRYPT_XML_KEY_VALUE_TYPE_DSA = 0x00000001;
  static const DWORD CRYPT_XML_KEY_VALUE_TYPE_RSA = 0x00000002;
  static const DWORD CRYPT_XML_KEY_VALUE_TYPE_ECDSA = 0x00000003;
  static const DWORD CRYPT_XML_KEY_VALUE_TYPE_CUSTOM = 0x00000004;
  ...
  static const DWORD CRYPT_XML_X509DATA_TYPE_ISSUER_SERIAL = 0x00000001;
  static const DWORD CRYPT_XML_X509DATA_TYPE_SKI = 0x00000002;
  static const DWORD CRYPT_XML_X509DATA_TYPE_SUBJECT_NAME = 0x00000003;
  static const DWORD CRYPT_XML_X509DATA_TYPE_CERTIFICATE = 0x00000004;
  static const DWORD CRYPT_XML_X509DATA_TYPE_CRL = 0x00000005;
  static const DWORD CRYPT_XML_X509DATA_TYPE_CUSTOM = 0x00000006;
  ...
  static const DWORD CRYPT_XML_KEYINFO_TYPE_KEYNAME = 0x00000001;
  static const DWORD CRYPT_XML_KEYINFO_TYPE_KEYVALUE = 0x00000002;
  static const DWORD CRYPT_XML_KEYINFO_TYPE_RETRIEVAL = 0x00000003;
  static const DWORD CRYPT_XML_KEYINFO_TYPE_X509DATA = 0x00000004;
  static const DWORD CRYPT_XML_KEYINFO_TYPE_CUSTOM = 0x00000005;
  ...
  static const UINT CRYPT_XML_PROPERTY_MAX_HEAP_SIZE = 1;
  static const UINT CRYPT_XML_PROPERTY_SIGNATURE_LOCATION = 2;
  static const UINT CRYPT_XML_PROPERTY_MAX_SIGNATURES = 3;
  static const UINT CRYPT_XML_PROPERTY_DOC_DECLARATION = 4;
  static const UINT CRYPT_XML_PROPERTY_XML_OUTPUT_CHARSET = 5;
  ...
  static const UINT CRYPT_XML_KEYINFO_SPEC_NONE = 0;
  static const UINT CRYPT_XML_KEYINFO_SPEC_ENCODED = 1;
  static const UINT CRYPT_XML_KEYINFO_SPEC_PARAM = 2;
  HRESULT CryptXmlCreateReference(  HCRYPTXML hCryptXml, DWORD dwFlags, LPCWSTR wszId, LPCWSTR wszURI, LPCWSTR wszType, WINAPI_CRYPT_XML_ALGORITHM* pDigestMethod, ULONG cTransform, WINAPI_CRYPT_XML_ALGORITHM* rgTransform, HCRYPTXML* phReference);
  HRESULT CryptXmlAddObject(        HCRYPTXML hSignatureOrObject, DWORD dwFlags, WINAPI_CRYPT_XML_PROPERTY* rgProperty, ULONG cProperty, WINAPI_PCRYPT_XML_BLOB pEncoded, WINAPI_CRYPT_XML_OBJECT** ppObject);
  ...
  HRESULT CryptXmlEncode(           HCRYPTXML hCryptXml, CRYPT_XML_CHARSET dwCharset, WINAPI_CRYPT_XML_PROPERTY* rgProperty, ULONG cProperty, void* pvCallbackState, PFN_CRYPT_XML_WRITE_CALLBACK pfnWrite);
  HRESULT CryptXmlGetAlgorithmInfo( WINAPI_CRYPT_XML_ALGORITHM* pXmlAlgorithm, DWORD dwFlags, CRYPT_XML_ALGORITHM_INFO** ppAlgInfo);
  HRESULT CryptXmlGetDocContext(    HCRYPTXML hCryptXml, WINAPI_CRYPT_XML_DOC_CTXT** ppStruct);
  HRESULT CryptXmlGetReference(     HCRYPTXML HCRYPTXML, WINAPI_CRYPT_XML_REFERENCE** ppStruct);
  HRESULT CryptXmlGetSignature(     HCRYPTXML hCryptXml, WINAPI_CRYPT_XML_SIGNATURE** ppStruct);
  ...
  HRESULT CryptXmlOpenToDecode(     CRYPT_XML_TRANSFORM_CHAIN_CONFIG* pConfig, DWORD dwFlags, WINAPI_CRYPT_XML_PROPERTY* rgProperty, ULONG cProperty, WINAPI_CRYPT_XML_BLOB* pEncoded, HCRYPTXML phCryptXml);
  HRESULT CryptXmlSetHMACSecret(    HCRYPTXML hSignature, WINAPI_BYTE* pbSecret, ULONG cbSecret);
  HRESULT CryptXmlVerifySignature(  HCRYPTXML hSignature, BCRYPT_KEY_HANDLE hKey, DWORD dwFlags);
  HRESULT CryptXmlSign(             HCRYPTXML hSignature, HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hKey, DWORD dwKeySpec, DWORD dwFlags, CRYPT_XML_KEYINFO_SPEC dwKeyInfoSpec, WINAPI_void* pvKeyInfoSpec, WINAPI_CRYPT_XML_ALGORITHM* pSignatureMethod, WINAPI_CRYPT_XML_ALGORITHM* pCanonicalization);
]]
