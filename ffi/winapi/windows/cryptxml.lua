...
ffi.cdef [[
  ...
  typedef DWORD CRYPT_XML_KEY_VALUE_TYPE; //Alias
  static const CRYPT_XML_KEY_VALUE_TYPE CRYPT_XML_KEY_VALUE_TYPE_DSA = 0x00000001;
  static const CRYPT_XML_KEY_VALUE_TYPE CRYPT_XML_KEY_VALUE_TYPE_RSA = 0x00000002;
  static const CRYPT_XML_KEY_VALUE_TYPE CRYPT_XML_KEY_VALUE_TYPE_ECDSA = 0x00000003;
  static const CRYPT_XML_KEY_VALUE_TYPE CRYPT_XML_KEY_VALUE_TYPE_CUSTOM = 0x00000004;
  ...
  typedef union CRYPT_XML_KEY_VALUE_u {
  ...
  typedef DWORD CRYPT_XML_X509DATA_TYPE; //Alias
  static const CRYPT_XML_X509DATA_TYPE CRYPT_XML_X509DATA_TYPE_ISSUER_SERIAL = 0x00000001;
  static const CRYPT_XML_X509DATA_TYPE CRYPT_XML_X509DATA_TYPE_SKI = 0x00000002;
  static const CRYPT_XML_X509DATA_TYPE CRYPT_XML_X509DATA_TYPE_SUBJECT_NAME = 0x00000003;
  static const CRYPT_XML_X509DATA_TYPE CRYPT_XML_X509DATA_TYPE_CERTIFICATE = 0x00000004;
  static const CRYPT_XML_X509DATA_TYPE CRYPT_XML_X509DATA_TYPE_CRL = 0x00000005;
  static const CRYPT_XML_X509DATA_TYPE CRYPT_XML_X509DATA_TYPE_CUSTOM = 0x00000006;
  typedef struct CRYPT_XML_ISSUER_SERIAL {
    LPCWSTR wszIssuer;
    LPCWSTR wszSerial;
  } CRYPT_XML_ISSUER_SERIAL;
  typedef union CRYPT_XML_X509DATA_ITEM_u {
  ...
  typedef DWORD CRYPT_XML_KEYINFO_TYPE; //Alias
  static const CRYPT_XML_KEYINFO_TYPE CRYPT_XML_KEYINFO_TYPE_KEYNAME = 0x00000001;
  static const CRYPT_XML_KEYINFO_TYPE CRYPT_XML_KEYINFO_TYPE_KEYVALUE = 0x00000002;
  static const CRYPT_XML_KEYINFO_TYPE CRYPT_XML_KEYINFO_TYPE_RETRIEVAL = 0x00000003;
  static const CRYPT_XML_KEYINFO_TYPE CRYPT_XML_KEYINFO_TYPE_X509DATA = 0x00000004;
  static const CRYPT_XML_KEYINFO_TYPE CRYPT_XML_KEYINFO_TYPE_CUSTOM = 0x00000005;
  typedef union CRYPT_XML_KEY_INFO_ITEM_u {
    LPCWSTR wszKeyName;
