...
ffi.cdef [[
  ...
  BOOL                                CryptDecodeObjectEx(                                WINAPI_CertEncodingType dwCertEncodingType, LPCSTR lpszStructType, WINAPI_BYTE* pbEncoded, DWORD cbEncoded, WINAPI_CryptDecodeObjectFlags dwFlags, PCRYPT_DECODE_PARA pDecodePara, void* pvStructInfo, DWORD* pcbStructInfo);
  BOOL                                CryptEncodeObject(                                  WINAPI_CertEncodingType dwCertEncodingType, LPCSTR lpszStructType, WINAPI_void* pvStructInfo, BYTE* pbEncoded, DWORD* pcbEncoded);
  BOOL                                CryptEncodeObjectEx(                                WINAPI_CertEncodingType dwCertEncodingType, LPCSTR lpszStructType, WINAPI_void* pvStructInfo, WINAPI_CryptEncodeObjectFlags dwFlags, PCRYPT_ENCODE_PARA pEncodePara, void* pvEncoded, DWORD* pcbEncoded);
  ...
  BOOL                                CertControlStore(                                   HCERTSTORE hCertStore, DWORD dwFlags, WINAPI_CertControlType dwCtrlType, WINAPI_void* pvCtrlPara);
  HCERTSTORE                          CertDuplicateStore(                                 HCERTSTORE hCertStore);
  BOOL                                CertEnumPhysicalStore(                              WINAPI_void* pvSystemStore, DWORD dwFlags, void* pvArg, PFN_CERT_ENUM_PHYSICAL_STORE pfnEnum);
  ...
  HCERTSTORE                          CertOpenStore(                                      WINAPI_CERT_STORE_PROVIDER lpszStoreProvider, WINAPI_CertEncodingType dwMsgAndCertEncodingType, HCRYPTPROV_LEGACY hCryptProv, WINAPI_CertOpenStoreFlags dwFlags, WINAPI_void* pvPara);
  HCERTSTORE                          CertOpenSystemStore(                                HCRYPTPROV_LEGACY hprov, LPCTSTR szSubsystemProtocol);
  BOOL                                CertRegisterPhysicalStore(                          WINAPI_void* pvSystemStore, DWORD dwFlags, LPCWSTR pwszStoreName, PCERT_PHYSICAL_STORE_INFO pStoreInfo, void* pvReserved);
  BOOL                                CertRegisterSystemStore(                            WINAPI_void* pvSystemStore, DWORD dwFlags, PCERT_SYSTEM_STORE_INFO pStoreInfo, void* pvReserved);
  ...
  BOOL                                CertSetStoreProperty(                               HCERTSTORE hCertStore, DWORD dwPropId, DWORD dwFlags, WINAPI_void* pvData);
  BOOL                                CertUnregisterPhysicalStore(                        WINAPI_void* pvSystemStore, DWORD dwFlags, LPCWSTR pwszStoreName);
  BOOL                                CertUnregisterSystemStore(                          WINAPI_void* pvSystemStore, DWORD dwFlags);
  BOOL                                CertAddSerializedElementToStore(                    HCERTSTORE hCertStore, WINAPI_BYTE* pbElement, DWORD cbElement, DWORD dwAddDisposition, DWORD dwFlags, DWORD dwContextTypeFlags, WINAPI_CertificateStoreContextType* pdwContextType, WINAPI_void** ppvContext);
  WINAPI_void*                        CertCreateContext(                                  WINAPI_CertificateStoreContextType dwContextType, WINAPI_CertEncodingType dwEncodingType, WINAPI_BYTE* pbEncoded, DWORD cbEncoded, WINAPI_CertCreateContextFlags dwFlags, PCERT_CREATE_CONTEXT_PARA pCreatePara);
  ...
  BOOL                                CertAddEncodedCertificateToStore(                   HCERTSTORE hCertStore, WINAPI_CertEncodingType dwCertEncodingType, WINAPI_BYTE* pbCertEncoded, DWORD cbCertEncoded, WINAPI_CertStoreAddDisposition dwAddDisposition, PCCERT_CONTEXT* ppCertContext);
  ...
  PCCERT_CONTEXT                      CertCreateCertificateContext(                       WINAPI_CertEncodingType dwCertEncodingType, WINAPI_BYTE* pbCertEncoded, DWORD cbCertEncoded);
  ...
  PCCERT_CONTEXT                      CertFindCertificateInStore(                         HCERTSTORE hCertStore, WINAPI_CertEncodingType dwCertEncodingType, DWORD dwFindFlags, WINAPI_CertFindType dwFindType, WINAPI_void* pvFindPara, PCCERT_CONTEXT pPrevCertContext);
  ...
  BOOL                                CertAddEncodedCRLToStore(                           HCERTSTORE hCertStore, WINAPI_CertEncodingType dwCertEncodingType, WINAPI_BYTE* pbCrlEncoded, DWORD cbCrlEncoded, DWORD dwAddDisposition, PCCRL_CONTEXT* ppCrlContext);
  PCCRL_CONTEXT                       CertCreateCRLContext(                               WINAPI_CertEncodingType dwCertEncodingType, WINAPI_BYTE* pbCrlEncoded, DWORD cbCrlEncoded);
  ...
  PCCRL_CONTEXT                       CertFindCRLInStore(                                 HCERTSTORE hCertStore, WINAPI_CertEncodingType dwEncodingType, WINAPI_CrlFindIssuedByFlags dwFindFlags, WINAPI_CrlFindType dwFindType, WINAPI_void* pvFindPara, PCCRL_CONTEXT pPrevCrlContext);
  ...
  BOOL                                CertAddEncodedCTLToStore(                           HCERTSTORE hCertStore, DWORD dwMsgAndCertEncodingType, WINAPI_BYTE* pbCtlEncoded, DWORD cbCtlEncoded, DWORD dwAddDisposition, PCCTL_CONTEXT* ppCtlContext);
  PCCTL_CONTEXT                       CertCreateCTLContext(                               DWORD dwMsgAndCertEncodingType, WINAPI_BYTE* pbCtlEncoded, DWORD cbCtlEncoded);
  ...
  PCCTL_CONTEXT                       CertFindCTLInStore(                                 HCERTSTORE hCertStore, DWORD dwMsgAndCertEncodingType, DWORD dwFindFlags, DWORD dwFindType, WINAPI_void* pvFindPara, PCCTL_CONTEXT pPrevCtlContext);
  ...
  BOOL                                CertSetCertificateContextProperty(                  PCCERT_CONTEXT pCertContext, WINAPI_CertPropId dwPropId, WINAPI_CertSetPropertyFlags dwFlags, WINAPI_void* pvData);
  BOOL                                CertSetCRLContextProperty(                          PCCRL_CONTEXT pCrlContext, WINAPI_CertPropId dwPropId, WINAPI_CertSetPropertyFlags dwFlags, WINAPI_void* pvData);
  BOOL                                CertSetCTLContextProperty(                          PCCTL_CONTEXT pCtlContext, WINAPI_CertPropId dwPropId, DWORD dwFlags, WINAPI_void* pvData);
  ...
  PCCERT_CHAIN_CONTEXT                CertFindChainInStore(                               HCERTSTORE hCertStore, WINAPI_CertEncodingType dwCertEncodingType, DWORD dwFindFlags, DWORD dwFindType, WINAPI_void* pvFindPara, PCCERT_CHAIN_CONTEXT pPrevChainContext);
  ...
  DWORD                               CryptMsgCalculateEncodedLength(                     WINAPI_CertEncodingType dwMsgEncodingType, DWORD dwFlags, WINAPI_CryptMsgType dwMsgType, WINAPI_void* pvMsgEncodeInfo, LPSTR pszInnerContentObjID, DWORD cbData);
  BOOL                                CryptMsgClose(                                      HCRYPTMSG hCryptMsg);
  BOOL                                CryptMsgControl(                                    HCRYPTMSG hCryptMsg, WINAPI_CryptMsgControlFlags dwFlags, WINAPI_CryptMsgControlType dwCtrlType, WINAPI_void* pvCtrlPara);
  BOOL                                CryptMsgUpdate(                                     HCRYPTMSG hCryptMsg, WINAPI_BYTE* pbData, DWORD cbData, BOOL fFinal);
  ...
  HCRYPTMSG                           CryptMsgOpenToEncode(                               WINAPI_CertEncodingType dwMsgEncodingType, DWORD dwFlags, WINAPI_CryptMsgType dwMsgType, WINAPI_void* pvMsgEncodeInfo, LPSTR pszInnerContentObjID, PCMSG_STREAM_INFO pStreamInfo);
  ...
  BOOL                                CryptDecodeMessage(                                 DWORD dwMsgTypeFlags, PCRYPT_DECRYPT_MESSAGE_PARA pDecryptPara, PCRYPT_VERIFY_MESSAGE_PARA pVerifyPara, DWORD dwSignerIndex, WINAPI_BYTE* pbEncodedBlob, DWORD cbEncodedBlob, DWORD dwPrevInnerContentType, WINAPI_CryptMsgType* pdwMsgType, DWORD* pdwInnerContentType, BYTE* pbDecoded, DWORD* pcbDecoded, PCCERT_CONTEXT* ppXchgCert, PCCERT_CONTEXT* ppSignerCert);
  BOOL                                CryptDecryptAndVerifyMessageSignature(              PCRYPT_DECRYPT_MESSAGE_PARA pDecryptPara, PCRYPT_VERIFY_MESSAGE_PARA pVerifyPara, DWORD dwSignerIndex, WINAPI_BYTE* pbEncryptedBlob, DWORD cbEncryptedBlob, BYTE* pbDecrypted, DWORD* pcbDecrypted, PCCERT_CONTEXT* ppXchgCert, PCCERT_CONTEXT* ppSignerCert);
  BOOL                                CryptDecryptMessage(                                PCRYPT_DECRYPT_MESSAGE_PARA pDecryptPara, WINAPI_BYTE* pbEncryptedBlob, DWORD cbEncryptedBlob, BYTE* pbDecrypted, DWORD* pcbDecrypted, PCCERT_CONTEXT* ppXchgCert);
  BOOL                                CryptEncryptMessage(                                PCRYPT_ENCRYPT_MESSAGE_PARA pEncryptPara, DWORD cRecipientCert, PCCERT_CONTEXT rgpRecipientCert, WINAPI_BYTE* pbToBeEncrypted, DWORD cbToBeEncrypted, BYTE* pbEncryptedBlob, DWORD* pcbEncryptedBlob);
  HCERTSTORE                          CryptGetMessageCertificates(                        DWORD dwMsgAndCertEncodingType, HCRYPTPROV_LEGACY hCryptProv, DWORD dwFlags, WINAPI_BYTE* pbSignedBlob, DWORD cbSignedBlob);
  LONG                                CryptGetMessageSignerCount(                         WINAPI_CertEncodingType dwMsgEncodingType, WINAPI_BYTE* pbSignedBlob, DWORD cbSignedBlob);
  BOOL                                CryptHashMessage(                                   PCRYPT_HASH_MESSAGE_PARA pHashPara, BOOL fDetachedHash, DWORD cToBeHashed, WINAPI_BYTE* rgpbToBeHashed, DWORD rgcbToBeHashed, BYTE* pbHashedBlob, DWORD* pcbHashedBlob, BYTE* pbComputedHash, DWORD* pcbComputedHash);
  BOOL                                CryptSignAndEncryptMessage(                         PCRYPT_SIGN_MESSAGE_PARA pSignPara, PCRYPT_ENCRYPT_MESSAGE_PARA pEncryptPara, DWORD cRecipientCert, PCCERT_CONTEXT rgpRecipientCert, WINAPI_BYTE* pbToBeSignedAndEncrypted, DWORD cbToBeSignedAndEncrypted, BYTE* pbSignedAndEncryptedBlob, DWORD* pcbSignedAndEncryptedBlob);
  BOOL                                CryptSignMessageWithKey(                            PCRYPT_KEY_SIGN_MESSAGE_PARA pSignPara, WINAPI_BYTE* pbToBeSigned, DWORD cToBeSigned, BYTE* pbSignedBlob, DWORD* pcbSignedBlob);
  BOOL                                CryptSignMessage(                                   PCRYPT_SIGN_MESSAGE_PARA pSignPara, BOOL fDetachedSignature, DWORD cToBeSigned, WINAPI_BYTE* rgpbToBeSigned, DWORD rgcbToBeSigned, BYTE* pbSignedBlob, DWORD* pcbSignedBlob);
  BOOL                                CryptVerifyDetachedMessageHash(                     PCRYPT_HASH_MESSAGE_PARA pHashPara, BYTE* pbDetachedHashBlob, DWORD cbDetachedHashBlob, DWORD cToBeHashed, WINAPI_BYTE* rgpbToBeHashed, DWORD rgcbToBeHashed, BYTE* pbComputedHash, DWORD* pcbComputedHash);
  BOOL                                CryptVerifyDetachedMessageSignature(                PCRYPT_VERIFY_MESSAGE_PARA pVerifyPara, DWORD dwSignerIndex, WINAPI_BYTE* pbDetachedSignBlob, DWORD cbDetachedSignBlob, DWORD cToBeSigned, WINAPI_BYTE* rgpbToBeSigned, DWORD rgcbToBeSigned, PCCERT_CONTEXT* ppSignerCert);
  ...
  BOOL                                CryptVerifyMessageSignature(                        PCRYPT_VERIFY_MESSAGE_PARA pVerifyPara, DWORD dwSignerIndex, WINAPI_BYTE* pbSignedBlob, DWORD cbSignedBlob, BYTE* pbDecoded, DWORD* pcbDecoded, PCCERT_CONTEXT* ppSignerCert);
  BOOL                                CryptVerifyMessageSignatureWithKey(                 PCRYPT_KEY_VERIFY_MESSAGE_PARA pVerifyPara, PCERT_PUBLIC_KEY_INFO pPublicKeyInfo, WINAPI_BYTE* pbSignedBlob, DWORD cbSignedBlob, BYTE* pbDecoded, DWORD* pcbDecoded);
  ...
  BOOL                                CryptHashCertificate(                               HCRYPTPROV_LEGACY hCryptProv, ALG_ID Algid, DWORD dwFlags, WINAPI_BYTE* pbEncoded, DWORD cbEncoded, BYTE* pbComputedHash, DWORD* pcbComputedHash);
  ...
  BOOL                                CryptHashToBeSigned(                                HCRYPTPROV_LEGACY hCryptProv, WINAPI_CertEncodingType dwCertEncodingType, WINAPI_BYTE* pbEncoded, DWORD cbEncoded, BYTE* pbComputedHash, DWORD* pcbComputedHash);
  ...
  BOOL                                CryptQueryObject(                                   WINAPI_CryptObjectType dwObjectType, WINAPI_void* pvObject, WINAPI_CryptExpectedContentType dwExpectedContentTypeFlags, WINAPI_CryptExpectedFormatType dwExpectedFormatTypeFlags, DWORD dwFlags, WINAPI_CertEncodingType* pdwMsgAndCertEncodingType, WINAPI_CryptContentType* pdwContentType, WINAPI_CryptFormatType* pdwFormatType, HCERTSTORE* phCertStore, HCRYPTMSG* phMsg, WINAPI_void** ppvContext);
  BOOL                                CryptSignAndEncodeCertificate(                      HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey, WINAPI_CryptKeySpec dwKeySpec, WINAPI_CertEncodingType dwCertEncodingType, LPCSTR lpszStructType, WINAPI_void* pvStructInfo, PCRYPT_ALGORITHM_IDENTIFIER pSignatureAlgorithm, WINAPI_void* pvHashAuxInfo, PBYTE pbEncoded, DWORD* pcbEncoded);
  BOOL                                CryptSignCertificate(                               HCRYPTPROV_OR_NCRYPT_KEY_HANDLE hCryptProvOrNCryptKey, WINAPI_CryptKeySpec dwKeySpec, WINAPI_CertEncodingType dwCertEncodingType, WINAPI_BYTE* pbEncodedToBeSigned, DWORD cbEncodedToBeSigned, PCRYPT_ALGORITHM_IDENTIFIER pSignatureAlgorithm, WINAPI_void* pvHashAuxInfo, BYTE* pbSignature, DWORD* pcbSignature);
  ...
  BOOL                                CryptSIPLoad(                                       WINAPI_GUID* pgSubject, DWORD dwFlags, SIP_DISPATCH_INFO* pSipDispatch);
  ...
  BOOL                                CryptBinaryToString(                                WINAPI_BYTE* pbBinary, DWORD cbBinary, WINAPI_CryptStringFlags dwFlags, LPTSTR pszString, DWORD* pcchString);
  BOOL                                CryptFormatObject(                                  WINAPI_CertEncodingType dwCertEncodingType, DWORD dwFormatType, WINAPI_CryptFormatStrType dwFormatStrType, void* pFormatStruct, LPCSTR lpszStructType, WINAPI_BYTE* pbEncoded, DWORD cbEncoded, void* pbFormat, DWORD* pcbFormat);
  ...
  BOOL                                CryptCreateKeyIdentifierFromCSP(                    WINAPI_CertEncodingType dwCertEncodingType, LPCSTR pszPubKeyOID, WINAPI_PUBLICKEYSTRUC* pPubKeyStruc, DWORD cbPubKeyStruc, DWORD dwFlags, void* pvReserved, BYTE* pbHash, DWORD* pcbHash);
  BOOL                                CryptEnumKeyIdentifierProperties(                   WINAPI_CRYPT_HASH_BLOB* pKeyIdentifier, DWORD dwPropId, DWORD dwFlags, LPCWSTR pwszComputerName, void* pvReserved, void* pvArg, PFN_CRYPT_ENUM_KEYID_PROP pfnEnum);
  BOOL                                CryptGetKeyIdentifierProperty(                      WINAPI_CRYPT_HASH_BLOB* pKeyIdentifier, DWORD dwPropId, DWORD dwFlags, LPCWSTR pwszComputerName, void* pvReserved, void* pvData, DWORD* pcbData);
  BOOL                                CryptSetKeyIdentifierProperty(                      WINAPI_CRYPT_HASH_BLOB* pKeyIdentifier, DWORD dwPropId, DWORD dwFlags, LPCWSTR pwszComputerName, void* pvReserved, WINAPI_void* pvData);
  ...
  BOOL                                CryptSetOIDFunctionValue(                           WINAPI_CertEncodingType dwEncodingType, LPCSTR pszFuncName, LPCSTR pszOID, LPCWSTR pwszValueName, DWORD dwValueType, WINAPI_BYTE* pbValueData, DWORD cbValueData);
