...
ffi.cdef [[
  ...
  typedef DWORD CryptRetrievalFlags; //Alias
  typedef DWORD CryptGetObjectUrlFlags; //Alias
  BOOL CryptGetObjectUrl(        LPCSTR pszUrlOid, LPVOID pvPara, CryptGetObjectUrlFlags dwFlags, PCRYPT_URL_ARRAY pUrlArray, DWORD* pcbUrlArray, PCRYPT_URL_INFO pUrlInfo, DWORD* pcbUrlInfo, LPVOID pvReserved);
  BOOL CryptRetrieveObjectByUrl( LPCTSTR pszUrl, LPCSTR pszObjectOid, CryptRetrievalFlags dwRetrievalFlags, DWORD dwTimeout, LPVOID* ppvObject, HCRYPTASYNC hAsyncRetrieve, PCRYPT_CREDENTIALS pCredentials, LPVOID pvVerify, PCRYPT_RETRIEVE_AUX_INFO pAuxInfo);
]]
