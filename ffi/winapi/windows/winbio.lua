...
ffi.cdef [[
  ...
  static const ULONG WINBIO_POOL_UNKNOWN = 0;
  static const ULONG WINBIO_POOL_SYSTEM = 1;
  static const ULONG WINBIO_POOL_PRIVATE = 2;
  static const ULONG WINBIO_POOL_UNASSIGNED = 3;
  typedef struct WINBIO_VERSION {
    DWORD MajorVersion;
    DWORD MinorVersion;
  } WINBIO_VERSION;
  typedef UINT WINBIO_IDENTITY_TYPE; //Alias
  static const UINT WINBIO_ID_TYPE_NULL = 0;
  static const UINT WINBIO_ID_TYPE_WILDCARD = 1;
  static const UINT WINBIO_ID_TYPE_GUID = 2;
  static const UINT WINBIO_ID_TYPE_SID = 3;
  ...
  static const ULONG WINBIO_PROPERTY_TYPE_SESSION = 1;
  static const ULONG WINBIO_PROPERTY_TYPE_UNIT = 2;
  static const ULONG WINBIO_PROPERTY_TYPE_TEMPLATE = 3;
  typedef UINT WINBIO_CREDENTIAL_FORMAT; //Alias
  static const UINT WINBIO_PASSWORD_GENERIC = 0x00000001;
  static const UINT WINBIO_PASSWORD_PACKED = 0x00000002;
  typedef ULONG WINBIO_COMPONENT; //Alias
  static const ULONG WINBIO_COMPONENT_SENSOR = 1;
  static const ULONG WINBIO_COMPONENT_ENGINE = 2;
  static const ULONG WINBIO_COMPONENT_STORAGE = 3;
  ...
  static const UCHAR WINBIO_SUBTYPE_NO_INFORMATION = 0x00;
  static const UCHAR WINBIO_SUBTYPE_ANY = 0xFF;
  typedef ULONG WINBIO_REJECT_DETAIL; //Alias
  static const ULONG WINBIO_FP_TOO_HIGH = 1;
  static const ULONG WINBIO_FP_TOO_LOW = 2;
  static const ULONG WINBIO_FP_TOO_LEFT = 3;
  static const ULONG WINBIO_FP_TOO_RIGHT = 4;
  static const ULONG WINBIO_FP_TOO_FAST = 5;
  static const ULONG WINBIO_FP_TOO_SLOW = 6;
  static const ULONG WINBIO_FP_POOR_QUALITY = 7;
  static const ULONG WINBIO_FP_TOO_SKEWED = 8;
  static const ULONG WINBIO_FP_TOO_SHORT = 9;
  static const ULONG WINBIO_FP_MERGE_FAILURE = 10;
  typedef ULONG WINBIO_EVENT_TYPE; //Alias
  static const ULONG WINBIO_EVENT_ERROR = 0xFFFFFFFF;
  static const ULONG WINBIO_EVENT_FP_UNCLAIMED = 0x00000001;
  static const ULONG WINBIO_EVENT_FP_UNCLAIMED_IDENTIFY = 0x00000002;
  ...
  static const ULONG WINBIO_SETTING_SOURCE_INVALID = 0;
  static const ULONG WINBIO_SETTING_SOURCE_DEFAULT = 1;
  static const ULONG WINBIO_SETTING_SOURCE_POLICY = 2;
  static const ULONG WINBIO_SETTING_SOURCE_LOCAL = 3;
  typedef WINBIO_SETTING_SOURCE_TYPE *PWINBIO_SETTING_SOURCE_TYPE; //Pointer
  typedef ULONG WINBIO_PROPERTY_ID; //Alias
  static const ULONG WINBIO_PROPERTY_SAMPLE_HINT = 1;
  typedef UINT WINBIO_CREDENTIAL_STATE; //Alias
  static const UINT WINBIO_CREDENTIAL_NOT_SET = 0x00000001;
  static const UINT WINBIO_CREDENTIAL_SET = 0x00000002;
