...
# pragma pack( push, 1 )
  typedef struct ACMDRIVERDETAILS {
    ...
    DWORD cFilterTags;
    HICON hicon;
    TCHAR szShortName_ACMDRIVERDETAILS_SHORTNAME_CHARS_;
    TCHAR szLongName_ACMDRIVERDETAILS_LONGNAME_CHARS_;
    TCHAR szCopyright_ACMDRIVERDETAILS_COPYRIGHT_CHARS_;
    TCHAR szLicensing_ACMDRIVERDETAILS_LICENSING_CHARS_;
    TCHAR szFeatures_ACMDRIVERDETAILS_FEATURES_CHARS_;
  } ACMDRIVERDETAILS;
# pragma pack( pop )
...
# pragma pack( push, 1 )
  typedef struct ACMFILTERDETAILS {
    ...
    LPWAVEFILTER pwfltr;
    DWORD cbwfltr;
    TCHAR szFilter_ACMFILTERDETAILS_FILTER_CHARS_;
  } ACMFILTERDETAILS;
# pragma pack( pop )
...
# pragma pack( push, 1 )
  typedef struct ACMFILTERCHOOSE {
    ...
    DWORD cbwfltr;
    LPCTSTR pszTitle;
    TCHAR szFilterTag_ACMFILTERTAGDETAILS_FILTERTAG_CHARS_;
    TCHAR szFilter_ACMFILTERDETAILS_FILTER_CHARS_;
    LPTSTR pszName;
    DWORD cchName;
...
# pragma pack( push, 1 )
  typedef struct ACMFORMATCHOOSE {
    ...
    DWORD cbwfx;
    LPCWSTR pszTitle;
    TCHAR szFormatTag_ACMFORMATTAGDETAILS_FORMATTAG_CHARS_;
    TCHAR szFormat_ACMFORMATDETAILS_FORMAT_CHARS_;
    LPTSTR pszName;
    DWORD cchName;
...
# pragma pack( push, 1 )
  typedef struct ACMSTREAMHEADER {
    ...
    DWORD_PTR dwDstUser;
    DWORD dwReservedDriver__DRVRESERVED_;
  } ACMSTREAMHEADER;
# pragma pack( pop )
