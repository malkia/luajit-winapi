...
ffi.cdef [[
  ...
  typedef union CRYPTUI_WIZ_EXPORT_INFO_u {
  ...
  typedef DWORD CRYPTUI_WIZ_IMPORT_SRC_INFO_CHOICE; //Alias
  static const CRYPTUI_WIZ_IMPORT_SRC_INFO_CHOICE CRYPTUI_WIZ_IMPORT_SUBJECT_FILE = 1;
  static const CRYPTUI_WIZ_IMPORT_SRC_INFO_CHOICE CRYPTUI_WIZ_IMPORT_SUBJECT_CERT_CONTEXT = 2;
  static const CRYPTUI_WIZ_IMPORT_SRC_INFO_CHOICE CRYPTUI_WIZ_IMPORT_SUBJECT_CTL_CONTEXT = 3;
  static const CRYPTUI_WIZ_IMPORT_SRC_INFO_CHOICE CRYPTUI_WIZ_IMPORT_SUBJECT_CRL_CONTEXT = 4;
  static const CRYPTUI_WIZ_IMPORT_SRC_INFO_CHOICE CRYPTUI_WIZ_IMPORT_SUBJECT_CERT_STORE = 5;
  typedef union CRYPTUI_WIZ_IMPORT_SRC_INFO_u {
  ...
  typedef DWORD CRYPTUI_SELECT_FLAGS; //Alias
  typedef struct CRYPTUI_SELECTCERTIFICATE_STRUCT {
    DWORD dwSize;
    HWND hwndParent;
    DWORD dwFlags;
    LPCTSTR szTitle;
    CRYPTUI_SELECT_FLAGS dwDontUseColumn;
  ...
  typedef union CRYPTUI_WIZ_DIGITAL_SIGN_INFO_u1 {
    LPCWSTR pwszFileName;
  ...
  typedef union CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO_u {
    PCCRYPTUI_WIZ_DIGITAL_SIGN_PVK_FILE_INFO pPvkFileInfo;
    PCRYPT_KEY_PROV_INFO pPvkProvInfo;
  } CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO_u;
  typedef DWORD CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO_CHOICE; //Alias
  static const CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO_CHOICE CRYPTUI_WIZ_DIGITAL_SIGN_PVK_FILE = 0x01;
  static const CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO_CHOICE CRYPTUI_WIZ_DIGITAL_SIGN_PVK_PROV = 0x02;
  typedef struct CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO {
    DWORD dwSize;
    LPWSTR pwszSigningCertFileName;
    CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO_CHOICE dwPvkChoice;
    CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO_u ;
  } CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO;
  typedef CRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO *PCCRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO; //Pointer
  typedef union CRYPTUI_WIZ_DIGITAL_SIGN_INFO_u2 {
    PCCERT_CONTEXT pSigningCertContext;
    PCCRYPTUI_WIZ_DIGITAL_SIGN_STORE_INFO pSigningCertStore;
    PCCRYPTUI_WIZ_DIGITAL_SIGN_CERT_PVK_INFO pSigningCertPvkInfo;
  } CRYPTUI_WIZ_DIGITAL_SIGN_INFO_u2;
  typedef DWORD CRYPTUI_WIZ_DIGITAL_SIGN_EXTENDED_INFO_FLAGS; //Alias
  typedef struct CRYPTUI_WIZ_DIGITAL_SIGN_EXTENDED_INFO {
    DWORD dwSize;
    CRYPTUI_WIZ_DIGITAL_SIGN_EXTENDED_INFO_FLAGS dwAttrFlags;
  ...
  typedef DWORD CryptUiWizFlags; //Alias
  ...
  BOOL           CryptUIWizExport(                     CryptUiWizFlags dwFlags, HWND hwndParent, LPCWSTR pwszWizardTitle, PCCRYPTUI_WIZ_EXPORT_INFO pExportInfo, void* pvoid);
  BOOL           CryptUIWizImport(                     CryptUiWizFlags dwFlags, HWND hwndParent, LPCWSTR pwszWizardTitle, PCCRYPTUI_WIZ_IMPORT_SRC_INFO pImportSrc, HCERTSTORE hDestCertStore);
