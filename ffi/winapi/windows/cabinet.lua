...
ffi.cdef [[
  ...
  enum { cbMAX_LINE_mult_2 = 512 };
  typedef USHORT TCOMP; //Alias
  typedef int FCIERROR; //Alias
  static const FCIERROR FCIERR_NONE = 0;
  static const FCIERROR FCIERR_OPEN_SRC = 1;
  static const FCIERROR FCIERR_READ_SRC = 2;
  static const FCIERROR FCIERR_ALLOC_FAIL = 3;
  static const FCIERROR FCIERR_TEMP_FILE = 4;
  static const FCIERROR FCIERR_BAD_COMPR_TYPE = 5;
  static const FCIERROR FCIERR_CAB_FILE = 6;
  static const FCIERROR FCIERR_USER_ABORT = 7;
  static const FCIERROR FCIERR_MCI_FAIL = 8;
  static const FCIERROR FCIERR_CAB_FORMAT_LIMIT = 9;
  typedef int FDIERROR; //Alias
  static const FDIERROR FDIERROR_NONE = 0;
  static const FDIERROR FDIERROR_CABINET_NOT_FOUND = 1;
  static const FDIERROR FDIERROR_NOT_A_CABINET = 2;
  static const FDIERROR FDIERROR_UNKNOWN_CABINET_VERSION = 3;
  static const FDIERROR FDIERROR_CORRUPT_CABINET = 4;
  static const FDIERROR FDIERROR_ALLOC_FAIL = 5;
  static const FDIERROR FDIERROR_BAD_COMPR_TYPE = 6;
  static const FDIERROR FDIERROR_MDI_FAIL = 7;
  static const FDIERROR FDIERROR_TARGET_FILE = 8;
