...
ffi.cdef [[
  BOOL CreatePatchFile(                   LPCTSTR OldFileName, LPCTSTR NewFileName, LPCTSTR PatchFileName, PatchOptionFlags OptionFlags, PPATCH_OPTION_DATA OptionData);
  BOOL CreatePatchFileByHandles(          HANDLE OldFileHandle, HANDLE NewFileHandle, HANDLE PatchFileHandle, PatchOptionFlags OptionFlags, PPATCH_OPTION_DATA OptionData);
  BOOL CreatePatchFileByHandlesEx(        ULONG OldFileCount, PPATCH_OLD_FILE_INFO_H OldFileInfoArray, HANDLE NewFileHandle, HANDLE PatchFileHandle, PatchOptionFlags OptionFlags, PPATCH_OPTION_DATA OptionData, PPATCH_PROGRESS_CALLBACK ProgressCallback, PVOID CallbackContext);
  BOOL CreatePatchFileEx(                 ULONG OldFileCount, PPATCH_OLD_FILE_INFO OldFileInfoArray, LPCTSTR NewFileName, LPCTSTR PatchFileName, PatchOptionFlags OptionFlags, PPATCH_OPTION_DATA OptionData, PPATCH_PROGRESS_CALLBACK ProgressCallback, PVOID CallbackContext);
