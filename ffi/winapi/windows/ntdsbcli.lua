...
ffi.cdef [[
  ...
  typedef ULONG NtdsBackupType; //Alias
  typedef ULONG NtdsRestoreType; //Alias
  ...
  HRESULT DsBackupPrepare(               LPCTSTR szBackupServer, ULONG grbit, NtdsBackupType btBackupType, PVOID* ppvExpiryToken, LPDWORD pcbExpiryTokenSize, HBC* phbc);
  ...
  HRESULT DsRestorePrepare(              LPCWSTR szServerName, NtdsRestoreType rtFlag, PVOID pvExpiryToken, DWORD cbExpiryTokenSize, HBC* phbc);
