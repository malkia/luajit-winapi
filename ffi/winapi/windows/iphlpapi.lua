...
ffi.cdef [[
  ...
  NETIO_STATUS            ConvertInterfaceAliasToLuid(       const WCHAR* InterfaceAlias, PNET_LUID InterfaceLuid);
  NETIO_STATUS            ConvertInterfaceGuidToLuid(        const GUID* InterfaceGuid, PNET_LUID InterfaceLuid);
  NETIO_STATUS            ConvertInterfaceIndexToLuid(       NET_IFINDEX InterfaceIndex, PNET_LUID InterfaceLuid);
  NETIO_STATUS            ConvertInterfaceLuidToAlias(       const NET_LUID* InterfaceLuid, PWSTR InterfaceAlias, SIZE_T Length);
  NETIO_STATUS            ConvertInterfaceLuidToGuid(        const NET_LUID* InterfaceLuid, GUID* InterfaceGuid);
  NETIO_STATUS            ConvertInterfaceLuidToIndex(       const NET_LUID* InterfaceLuid, PNET_IFINDEX InterfaceIndex);
  NETIO_STATUS            ConvertInterfaceLuidToNameA(       const NET_LUID* InterfaceLuid, PSTR InterfaceName, SIZE_T Length);
  NETIO_STATUS            ConvertInterfaceLuidToNameW(       const NET_LUID* InterfaceLuid, PWSTR InterfaceName, SIZE_T Length);
  NETIO_STATUS            ConvertInterfaceNameToLuidA(       const CHAR* InterfaceName, PNET_LUID InterfaceLuid);
  NETIO_STATUS            ConvertInterfaceNameToLuidW(       const WCHAR* InterfaceName, PNET_LUID InterfaceLuid);
  ...
  WINAPI_ERROR_CODE       ParseNetworkString(                const WCHAR* NetworkString, DWORD Types, PNET_ADDRESS_INFO AddressInfo, USHORT* PortNumber, BYTE* PrefixLength);
