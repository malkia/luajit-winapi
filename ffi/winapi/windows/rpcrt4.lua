...
ffi.cdef [[
  ...
  static const WINAPI_BindingOptions RPC_C_OPT_BINDING_NONCAUSAL = 9;
  static const WINAPI_BindingOptions RPC_C_OPT_MAX_OPTIONS = 17;
  static const WINAPI_BindingOptions RPC_C_DONT_FAIL = 4;
  static const WINAPI_BindingOptions RPC_C_OPT_SESSION_ID = 6;
  static const WINAPI_BindingOptions RPC_C_OPT_COOKIE_AUTH = 7;
  static const WINAPI_BindingOptions RPC_C_OPT_RESOURCE_TYPE_UUID = 8;
  static const WINAPI_BindingOptions RPC_C_OPT_DONT_LINGER = 13;
  static const WINAPI_BindingOptions RPC_C_OPT_UNIQUE_BINDING = 11;
  ...
  RPC_STATUS           MesEncodeFixedBufferHandleCreate(    WINAPI_LPVOID_char* Buffer, unsigned long BufferSize, unsigned long* pEncodedSize, handle_t* pHandle);
  ...
  RPC_STATUS           RpcBindingInqAuthClient(             RPC_BINDING_HANDLE ClientBinding, RPC_AUTHZ_HANDLE* Privs, RPC_TSTR* ServerPrincName, WINAPI_RPC_C_AUTHN_LEVEL* AuthnLevel, WINAPI_RPC_C_AUTHN_SVC* AuthnSvc, WINAPI_RPC_C_AUTHZ* AuthzSvc);
  RPC_STATUS           RpcBindingInqAuthClientEx(           RPC_BINDING_HANDLE ClientBinding, RPC_AUTHZ_HANDLE* Privs, RPC_TSTR* ServerPrincName, WINAPI_RPC_C_AUTHN_LEVEL* AuthnLevel, WINAPI_RPC_C_AUTHN_SVC* AuthnSvc, WINAPI_RPC_C_AUTHZ* AuthzSvc, unsigned long flags);
  RPC_STATUS           RpcBindingInqAuthInfo(               RPC_BINDING_HANDLE Binding, RPC_TSTR* ServerPrincName, WINAPI_RPC_C_AUTHN_LEVEL* AuthnLevel, WINAPI_RPC_C_AUTHN_SVC* AuthnSvc, RPC_AUTH_IDENTITY_HANDLE* AuthIdentity, WINAPI_RPC_C_AUTHZ* AuthzSvc);
  RPC_STATUS           RpcBindingInqAuthInfoEx(             RPC_BINDING_HANDLE Binding, RPC_TSTR ServerPrincName, WINAPI_RPC_C_AUTHN_LEVEL* AuthnLevel, WINAPI_RPC_C_AUTHN_SVC* AuthnSvc, RPC_AUTH_IDENTITY_HANDLE* AuthIdentity, WINAPI_RPC_C_AUTHZ* AuthzSvc, unsigned long RpcQosVersion, RPC_SECURITY_QOS* SecurityQos);
  ...
  RPC_STATUS           RpcBindingSetAuthInfo(               RPC_BINDING_HANDLE Binding, RPC_TSTR ServerPrincName, WINAPI_RPC_C_AUTHN_LEVEL AuthnLevel, WINAPI_RPC_C_AUTHN_SVC AuthnSvc, RPC_AUTH_IDENTITY_HANDLE AuthIdentity, unsigned long AuthzService);
  RPC_STATUS           RpcBindingSetAuthInfoEx(             RPC_BINDING_HANDLE Binding, RPC_TSTR ServerPrincName, WINAPI_RPC_C_AUTHN_LEVEL AuthnLevel, WINAPI_RPC_C_AUTHN_SVC AuthnSvc, RPC_AUTH_IDENTITY_HANDLE AuthIdentity, WINAPI_RPC_C_AUTHZ AuthzSvc, RPC_SECURITY_QOS* SecurityQOS);
  RPC_STATUS           RpcBindingSetObject(                 RPC_BINDING_HANDLE Binding, UUID* ObjectUuid);
  RPC_STATUS           RpcBindingSetOption(                 RPC_BINDING_HANDLE hBinding, WINAPI_BindingOptions Option, unsigned long OptionValue);
  ...
  RPC_STATUS           RpcMgmtInqDefaultProtectLevel(       WINAPI_RPC_C_AUTHN_SVC AuthnSvc, WINAPI_RPC_C_AUTHN_LEVEL_unsigned_int* AuthnLevel);
  RPC_STATUS           RpcMgmtInqIfIds(                     RPC_BINDING_HANDLE Binding, RPC_IF_ID_VECTOR** IfIdVector);
  RPC_STATUS           RpcMgmtInqServerPrincName(           RPC_BINDING_HANDLE Binding, WINAPI_RPC_C_AUTHN_SVC AuthnSvc, RPC_TSTR* ServerPrincName);
  ...
  RPC_STATUS           RpcServerInqDefaultPrincName(        WINAPI_RPC_C_AUTHN_SVC AuthnSvc, RPC_TSTR* PrincName);
  ...
  RPC_STATUS           RpcServerRegisterAuthInfo(           RPC_TSTR ServerPrincName, WINAPI_RPC_C_AUTHN_SVC AuthnSvc, RPC_AUTH_KEY_RETRIEVAL_FN GetKeyFn, void* Arg);
  RPC_STATUS           RpcServerRegisterIf(                 RPC_IF_HANDLE IfSpec, UUID* MgrTypeUuid, RPC_MGR_EPV* MgrEpv);
  RPC_STATUS           RpcServerRegisterIf2(                RPC_IF_HANDLE IfSpec, UUID* MgrTypeUuid, RPC_MGR_EPV* MgrEpv, WINAPI_InterfaceRegistrationFlags Flags, unsigned int MaxCalls, unsigned int MaxRpcSize, RPC_IF_CALLBACK_FN* IfCallbackFn);
  RPC_STATUS           RpcServerRegisterIfEx(               RPC_IF_HANDLE IfSpec, UUID* MgrTypeUuid, RPC_MGR_EPV* MgrEpv, WINAPI_InterfaceRegistrationFlags Flags, unsigned int MaxCalls, RPC_IF_CALLBACK_FN* IfCallback);
  ...
  WINAPI_BOOL_int      UuidEqual(                           UUID* Uuid1, UUID* Uuid2, RPC_STATUS* Status);
