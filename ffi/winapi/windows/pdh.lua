...
ffi.cdef [[
  ...
  static const PDH_STATUS PDH_CSTATUS_VALID_DATA = 0x00000000;
  static const PDH_STATUS PDH_CSTATUS_NEW_DATA = 0x00000001;
  static const PDH_STATUS PDH_CSTATUS_NO_MACHINE = 0x800007D0;
  static const PDH_STATUS PDH_CSTATUS_NO_INSTANCE = 0x800007D1;
  static const PDH_STATUS PDH_MORE_DATA = 0x800007D2;
  static const PDH_STATUS PDH_CSTATUS_ITEM_NOT_VALIDATED = 0x800007D3;
  static const PDH_STATUS PDH_RETRY = 0x800007D4;
  static const PDH_STATUS PDH_NO_DATA = 0x800007D5;
  static const PDH_STATUS PDH_CALC_NEGATIVE_DENOMINATOR = 0x800007D6;
  static const PDH_STATUS PDH_CALC_NEGATIVE_TIMEBASE = 0x800007D7;
  static const PDH_STATUS PDH_CALC_NEGATIVE_VALUE = 0x800007D8;
  static const PDH_STATUS PDH_DIALOG_CANCELLED = 0x800007D9;
  static const PDH_STATUS PDH_END_OF_LOG_FILE = 0x800007DA;
  static const PDH_STATUS PDH_ASYNC_QUERY_TIMEOUT = 0x800007DB;
  static const PDH_STATUS PDH_CANNOT_SET_DEFAULT_REALTIME_DATASOURCE = 0x800007DC;
  static const PDH_STATUS PDH_UNABLE_MAP_NAME_FILES = 0x80000BD5;
  static const PDH_STATUS PDH_PLA_VALIDATION_WARNING = 0x80000BF3;
  static const PDH_STATUS PDH_CSTATUS_NO_OBJECT = 0xC0000BB8;
  static const PDH_STATUS PDH_CSTATUS_NO_COUNTER = 0xC0000BB9;
  static const PDH_STATUS PDH_CSTATUS_INVALID_DATA = 0xC0000BBA;
  static const PDH_STATUS PDH_MEMORY_ALLOCATION_FAILURE = 0xC0000BBB;
  static const PDH_STATUS PDH_INVALID_HANDLE = 0xC0000BBC;
  static const PDH_STATUS PDH_INVALID_ARGUMENT = 0xC0000BBD;
  static const PDH_STATUS PDH_FUNCTION_NOT_FOUND = 0xC0000BBE;
  static const PDH_STATUS PDH_CSTATUS_NO_COUNTERNAME = 0xC0000BBF;
  static const PDH_STATUS PDH_CSTATUS_BAD_COUNTERNAME = 0xC0000BC0;
  static const PDH_STATUS PDH_INVALID_BUFFER = 0xC0000BC1;
  static const PDH_STATUS PDH_INSUFFICIENT_BUFFER = 0xC0000BC2;
  static const PDH_STATUS PDH_CANNOT_CONNECT_MACHINE = 0xC0000BC3;
  static const PDH_STATUS PDH_INVALID_PATH = 0xC0000BC4;
  static const PDH_STATUS PDH_INVALID_INSTANCE = 0xC0000BC5;
  static const PDH_STATUS PDH_INVALID_DATA = 0xC0000BC6;
  static const PDH_STATUS PDH_NO_DIALOG_DATA = 0xC0000BC7;
  static const PDH_STATUS PDH_CANNOT_READ_NAME_STRINGS = 0xC0000BC8;
  static const PDH_STATUS PDH_LOG_FILE_CREATE_ERROR = 0xC0000BC9;
  static const PDH_STATUS PDH_LOG_FILE_OPEN_ERROR = 0xC0000BCA;
  static const PDH_STATUS PDH_LOG_TYPE_NOT_FOUND = 0xC0000BCB;
  static const PDH_STATUS PDH_NO_MORE_DATA = 0xC0000BCC;
  static const PDH_STATUS PDH_ENTRY_NOT_IN_LOG_FILE = 0xC0000BCD;
  static const PDH_STATUS PDH_DATA_SOURCE_IS_LOG_FILE = 0xC0000BCE;
  static const PDH_STATUS PDH_DATA_SOURCE_IS_REAL_TIME = 0xC0000BCF;
  static const PDH_STATUS PDH_UNABLE_READ_LOG_HEADER = 0xC0000BD0;
  static const PDH_STATUS PDH_FILE_NOT_FOUND = 0xC0000BD1;
  static const PDH_STATUS PDH_FILE_ALREADY_EXISTS = 0xC0000BD2;
  static const PDH_STATUS PDH_NOT_IMPLEMENTED = 0xC0000BD3;
  static const PDH_STATUS PDH_STRING_NOT_FOUND = 0xC0000BD4;
  static const PDH_STATUS PDH_UNKNOWN_LOG_FORMAT = 0xC0000BD6;
  static const PDH_STATUS PDH_UNKNOWN_LOGSVC_COMMAND = 0xC0000BD7;
  static const PDH_STATUS PDH_LOGSVC_QUERY_NOT_FOUND = 0xC0000BD8;
  static const PDH_STATUS PDH_LOGSVC_NOT_OPENED = 0xC0000BD9;
  static const PDH_STATUS PDH_WBEM_ERROR = 0xC0000BDA;
  static const PDH_STATUS PDH_ACCESS_DENIED = 0xC0000BDB;
  static const PDH_STATUS PDH_LOG_FILE_TOO_SMALL = 0xC0000BDC;
  static const PDH_STATUS PDH_INVALID_DATASOURCE = 0xC0000BDD;
  static const PDH_STATUS PDH_INVALID_SQLDB = 0xC0000BDE;
  static const PDH_STATUS PDH_NO_COUNTERS = 0xC0000BDF;
  static const PDH_STATUS PDH_SQL_ALLOC_FAILED = 0xC0000BE0;
  static const PDH_STATUS PDH_SQL_ALLOCCON_FAILED = 0xC0000BE1;
  static const PDH_STATUS PDH_SQL_EXEC_DIRECT_FAILED = 0xC0000BE2;
  static const PDH_STATUS PDH_SQL_FETCH_FAILED = 0xC0000BE3;
  static const PDH_STATUS PDH_SQL_ROWCOUNT_FAILED = 0xC0000BE4;
  static const PDH_STATUS PDH_SQL_MORE_RESULTS_FAILED = 0xC0000BE5;
  static const PDH_STATUS PDH_SQL_CONNECT_FAILED = 0xC0000BE6;
  static const PDH_STATUS PDH_SQL_BIND_FAILED = 0xC0000BE7;
  static const PDH_STATUS PDH_CANNOT_CONNECT_WMI_SERVER = 0xC0000BE8;
  static const PDH_STATUS PDH_PLA_COLLECTION_ALREADY_RUNNING = 0xC0000BE9;
  static const PDH_STATUS PDH_PLA_ERROR_SCHEDULE_OVERLAP = 0xC0000BEA;
  static const PDH_STATUS PDH_PLA_COLLECTION_NOT_FOUND = 0xC0000BEB;
  static const PDH_STATUS PDH_PLA_ERROR_SCHEDULE_ELAPSED = 0xC0000BEC;
  static const PDH_STATUS PDH_PLA_ERROR_NOSTART = 0xC0000BED;
  static const PDH_STATUS PDH_PLA_ERROR_ALREADY_EXISTS = 0xC0000BEE;
  static const PDH_STATUS PDH_PLA_ERROR_TYPE_MISMATCH = 0xC0000BEF;
  static const PDH_STATUS PDH_PLA_ERROR_FILEPATH = 0xC0000BF0;
  static const PDH_STATUS PDH_PLA_SERVICE_ERROR = 0xC0000BF1;
  static const PDH_STATUS PDH_PLA_VALIDATION_ERROR = 0xC0000BF2;
  static const PDH_STATUS PDH_PLA_ERROR_NAME_TOO_LONG = 0xC0000BF4;
  static const PDH_STATUS PDH_INVALID_SQL_LOG_FORMAT = 0xC0000BF5;
  static const PDH_STATUS PDH_COUNTER_ALREADY_IN_QUERY = 0xC0000BF6;
  static const PDH_STATUS PDH_BINARY_LOG_CORRUPT = 0xC0000BF7;
  static const PDH_STATUS PDH_LOG_SAMPLE_TOO_SMALL = 0xC0000BF8;
  static const PDH_STATUS PDH_OS_LATER_VERSION = 0xC0000BF9;
  static const PDH_STATUS PDH_OS_EARLIER_VERSION = 0xC0000BFA;
  static const PDH_STATUS PDH_INCORRECT_APPEND_TIME = 0xC0000BFB;
