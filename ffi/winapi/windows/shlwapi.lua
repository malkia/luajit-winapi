...
ffi.cdef [[
  ...
  static const UINT SHREGENUM_DEFAULT = 0x00000000;
  static const UINT SHREGENUM_HKCU = 0x00000001;
  static const UINT SHREGENUM_HKLM = 0x00000010;
  static const UINT SHREGENUM_BOTH = 0x00000011;
  typedef UINT SHREGDEL_FLAGS; //Alias
  static const UINT SHREGDEL_DEFAULT = 0x00000000;
  static const UINT SHREGDEL_HKCU = 0x00000001;
  static const UINT SHREGDEL_HKLM = 0x00000010;
  static const UINT SHREGDEL_BOTH = 0x00000011;
  ...
  static const UINT URLIS_URL = 0;
  static const UINT URLIS_OPAQUE = 1;
  static const UINT URLIS_NOHISTORY = 2;
  static const UINT URLIS_FILEURL = 3;
  static const UINT URLIS_APPLIABLE = 4;
  static const UINT URLIS_DIRECTORY = 5;
  static const UINT URLIS_HASQUERY = 6;
  typedef UINT URL_SCHEME; //Alias
  static const UINT URL_SCHEME_INVALID = -1;
  static const UINT URL_SCHEME_UNKNOWN = 0;
  static const UINT URL_SCHEME_FTP = 1;
  static const UINT URL_SCHEME_HTTP = 2;
  static const UINT URL_SCHEME_GOPHER = 3;
  static const UINT URL_SCHEME_MAILTO = 4;
  static const UINT URL_SCHEME_NEWS = 5;
  static const UINT URL_SCHEME_NNTP = 6;
  static const UINT URL_SCHEME_TELNET = 7;
  static const UINT URL_SCHEME_WAIS = 8;
  static const UINT URL_SCHEME_FILE = 9;
  static const UINT URL_SCHEME_MK = 10;
  static const UINT URL_SCHEME_HTTPS = 11;
  static const UINT URL_SCHEME_SHELL = 12;
  static const UINT URL_SCHEME_SNEWS = 13;
  static const UINT URL_SCHEME_LOCAL = 14;
  static const UINT URL_SCHEME_JAVASCRIPT = 15;
  static const UINT URL_SCHEME_VBSCRIPT = 16;
  static const UINT URL_SCHEME_ABOUT = 17;
  static const UINT URL_SCHEME_RES = 18;
  static const UINT URL_SCHEME_MSSHELLROOTED = 19;
  static const UINT URL_SCHEME_MSSHELLIDLIST = 20;
  static const UINT URL_SCHEME_MSHELP = 21;
  static const UINT URL_SCHEME_MSSHELLDEVICE = 22;
  static const UINT URL_SCHEME_WILDCARD = 23;
  static const UINT URL_SCHEME_SEARCH_MS = 24;
  static const UINT URL_SCHEME_SEARCH = 25;
  static const UINT URL_SCHEME_KNOWNFOLDER = 26;
  static const UINT URL_SCHEME_MAXVALUE = 27;
  ...
  static const UINT GLOBALCOUNTER_SEARCHMANAGER = 0;
  static const UINT GLOBALCOUNTER_SEARCHOPTIONS = 1;
  static const UINT GLOBALCOUNTER_FOLDERSETTINGSCHANGE = 2;
  static const UINT GLOBALCOUNTER_RATINGS = 3;
  static const UINT GLOBALCOUNTER_APPROVEDSITES = 4;
  static const UINT GLOBALCOUNTER_RESTRICTIONS = 5;
  static const UINT GLOBALCOUNTER_SHELLSETTINGSCHANGED = 6;
  static const UINT GLOBALCOUNTER_SYSTEMPIDLCHANGE = 7;
  static const UINT GLOBALCOUNTER_OVERLAYMANAGER = 8;
  static const UINT GLOBALCOUNTER_QUERYASSOCIATIONS = 9;
  static const UINT GLOBALCOUNTER_IESESSIONS = 10;
  static const UINT GLOBALCOUNTER_IEONLY_SESSIONS = 11;
  static const UINT GLOBALCOUNTER_APPLICATION_DESTINATIONS = 12;
  static const UINT GLOBALCOUNTER_CSCSYNCINPROGRESS = 13;
  static const UINT GLOBALCOUNTER_BITBUCKETNUMDELETERS = 14;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_SHARES = 15;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_A = 16;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_B = 17;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_C = 18;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_D = 19;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_E = 20;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_F = 21;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_G = 22;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_H = 23;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_I = 24;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_J = 25;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_K = 26;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_L = 27;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_M = 28;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_N = 29;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_O = 30;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_P = 31;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_Q = 32;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_R = 33;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_S = 34;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_T = 35;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_U = 36;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_V = 37;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_W = 38;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_X = 39;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_Y = 40;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_DRIVE_Z = 41;
  static const UINT GLOBALCOUNTER_RECYCLEDIRTYCOUNT_SERVERDRIVE = 42;
  static const UINT GLOBALCOUNTER_RECYCLEGLOBALDIRTYCOUNT = 43;
  static const UINT GLOBALCOUNTER_RECYCLEBINENUM = 44;
  static const UINT GLOBALCOUNTER_RECYCLEBINCORRUPTED = 45;
  static const UINT GLOBALCOUNTER_RATINGS_STATECOUNTER = 46;
  static const UINT GLOBALCOUNTER_PRIVATE_PROFILE_CACHE = 47;
  static const UINT GLOBALCOUNTER_INTERNETTOOLBAR_LAYOUT = 48;
  static const UINT GLOBALCOUNTER_FOLDERDEFINITION_CACHE = 49;
  static const UINT GLOBALCOUNTER_COMMONPLACES_LIST_CACHE = 50;
  static const UINT GLOBALCOUNTER_PRIVATE_PROFILE_CACHE_MACHINEWIDE = 51;
  static const UINT GLOBALCOUNTER_ASSOCCHANGED = 52;
  static const UINT GLOBALCOUNTER_APP_ITEMS_STATE_STORE_CACHE = 53;
  static const UINT GLOBALCOUNTER_IMMERSIVE_SCALE_CACHE = 54;
  static const UINT GLOBALCOUNTER_SETTINGSYNC_ENABLED = 55;
  typedef SHGLOBALCOUNTER WINAPI_SHGLOBALCOUNTER; //Alias
