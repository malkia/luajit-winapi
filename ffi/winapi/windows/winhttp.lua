...
ffi.cdef [[
  ...
  static const DWORD WINHTTP_FLAG_ASYNC = 0x10000000;
  typedef DWORD WINAPI_WinHttpOpenRequestFlags; //Alias
  typedef DWORD WINAPI_WinHttpOption; //Alias
  static const DWORD WINHTTP_OPTION_CALLBACK = 1;
  static const DWORD WINHTTP_OPTION_RESOLVE_TIMEOUT = 2;
  static const DWORD WINHTTP_OPTION_CONNECT_TIMEOUT = 3;
  static const DWORD WINHTTP_OPTION_CONNECT_RETRIES = 4;
  static const DWORD WINHTTP_OPTION_SEND_TIMEOUT = 5;
  static const DWORD WINHTTP_OPTION_RECEIVE_TIMEOUT = 6;
  static const DWORD WINHTTP_OPTION_RECEIVE_RESPONSE_TIMEOUT = 7;
  static const DWORD WINHTTP_OPTION_HANDLE_TYPE = 9;
  static const DWORD WINHTTP_OPTION_READ_BUFFER_SIZE = 12;
  static const DWORD WINHTTP_OPTION_WRITE_BUFFER_SIZE = 13;
  static const DWORD WINHTTP_OPTION_PARENT_HANDLE = 21;
  static const DWORD WINHTTP_OPTION_EXTENDED_ERROR = 24;
  static const DWORD WINHTTP_OPTION_SECURITY_FLAGS = 31;
  static const DWORD WINHTTP_OPTION_SECURITY_CERTIFICATE_STRUCT = 32;
  static const DWORD WINHTTP_OPTION_URL = 34;
  static const DWORD WINHTTP_OPTION_SECURITY_KEY_BITNESS = 36;
  static const DWORD WINHTTP_OPTION_PROXY = 38;
  static const DWORD WINHTTP_OPTION_USER_AGENT = 41;
  static const DWORD WINHTTP_OPTION_CONTEXT_VALUE = 45;
  static const DWORD WINHTTP_OPTION_CLIENT_CERT_CONTEXT = 47;
  static const DWORD WINHTTP_OPTION_REQUEST_PRIORITY = 58;
  static const DWORD WINHTTP_OPTION_HTTP_VERSION = 59;
  static const DWORD WINHTTP_OPTION_DISABLE_FEATURE = 63;
  static const DWORD WINHTTP_OPTION_CODEPAGE = 68;
  static const DWORD WINHTTP_OPTION_MAX_CONNS_PER_SERVER = 73;
  static const DWORD WINHTTP_OPTION_MAX_CONNS_PER_1_0_SERVER = 74;
  static const DWORD WINHTTP_OPTION_AUTOLOGON_POLICY = 77;
  static const DWORD WINHTTP_OPTION_SERVER_CERT_CONTEXT = 78;
  static const DWORD WINHTTP_OPTION_ENABLE_FEATURE = 79;
  static const DWORD WINHTTP_OPTION_WORKER_THREAD_COUNT = 80;
  static const DWORD WINHTTP_OPTION_PASSPORT_COBRANDING_TEXT = 81;
  static const DWORD WINHTTP_OPTION_PASSPORT_COBRANDING_URL = 82;
  static const DWORD WINHTTP_OPTION_CONFIGURE_PASSPORT_AUTH = 83;
  static const DWORD WINHTTP_OPTION_SECURE_PROTOCOLS = 84;
  static const DWORD WINHTTP_OPTION_ENABLETRACING = 85;
  static const DWORD WINHTTP_OPTION_PASSPORT_SIGN_OUT = 86;
  static const DWORD WINHTTP_OPTION_PASSPORT_RETURN_URL = 87;
  static const DWORD WINHTTP_OPTION_REDIRECT_POLICY = 88;
  static const DWORD WINHTTP_OPTION_MAX_HTTP_AUTOMATIC_REDIRECTS = 89;
  static const DWORD WINHTTP_OPTION_MAX_HTTP_STATUS_CONTINUE = 90;
  static const DWORD WINHTTP_OPTION_MAX_RESPONSE_HEADER_SIZE = 91;
  static const DWORD WINHTTP_OPTION_MAX_RESPONSE_DRAIN_SIZE = 92;
  static const DWORD WINHTTP_OPTION_CONNECTION_INFO = 93;
  static const DWORD WINHTTP_OPTION_CLIENT_CERT_ISSUER_LIST = 94;
  static const DWORD WINHTTP_OPTION_SPN = 96;
  static const DWORD WINHTTP_OPTION_GLOBAL_PROXY_CREDS = 97;
  static const DWORD WINHTTP_OPTION_GLOBAL_SERVER_CREDS = 98;
  static const DWORD WINHTTP_OPTION_UNLOAD_NOTIFY_EVENT = 99;
  static const DWORD WINHTTP_OPTION_REJECT_USERPWD_IN_URL = 100;
  static const DWORD WINHTTP_OPTION_USE_GLOBAL_SERVER_CREDENTIALS = 101;
  static const DWORD WINHTTP_OPTION_USERNAME = 0x1000;
  static const DWORD WINHTTP_OPTION_PASSWORD = 0x1001;
  static const DWORD WINHTTP_OPTION_PROXY_USERNAME = 0x1002;
  static const DWORD WINHTTP_OPTION_PROXY_PASSWORD = 0x1003;
