...
ffi.cdef [[
  ...
  typedef LPVOID PFN_AUTHENTICATION_CALLBACK;
  typedef LPVOID PFN_BLUETOOTH_ENUM_ATTRIBUTES_CALLBACK;
  typedef LPVOID PFN_DEVICE_CALLBACK;
  typedef LPVOID PFN_AUTHENTICATION_CALLBACK_EX;
  ...
  typedef BLUETOOTH_RADIO_INFO PBLUETOOTH_RADIO_INFO;
  ...
  typedef BLUETOOTH_OOB_DATA_INFO PBLUETOOTH_OOB_DATA_INFO;
  ...
  typedef BLUETOOTH_AUTHENTICATE_RESPONSE PBLUETOOTH_AUTHENTICATE_RESPONSE;
  ...
  typedef SDP_STRING_TYPE_DATA PSDP_STRING_TYPE_DATA;
  ...
  typedef SDP_ELEMENT_DATA PSDP_ELEMENT_DATA;
]]
