...
ffi.cdef [[
  typedef LPVOID SOCKET_PEER_TARGET_NAME*;
  typedef LPVOID SOCKET_SECURITY_QUERY_TEMPLATE*;
  typedef OVERLAPPED WSAOVERLAPPED;
  typedef WSAOVERLAPPED LPWSAOVERLAPPED;
  typedef LPVOID LPWSAOVERLAPPED_COMPLETION_ROUTINE;
  typedef LPVOID LPLOOKUPSERVICE_COMPLETION_ROUTINE;
  typedef int socklen_t;
  typedef LPVOID LPCONDITIONPROC;
  ...
  typedef ADDRESS_FAMILY WINAPI_ADDRESS_FAMILY_short;
  ...
  typedef DWORD WINAPI_WSA_PROVIDER_FLAGS;
  typedef DWORD WINAPI_WSA_SERVICE_FLAGS_1;
  ...
  typedef IN_ADDR struct in_addr;
  ...
  typedef ULONG WINAPI_SocketInfoFlags;
  ...
  typedef ULONG WINAPI_SocketSecurityFlags;
  ...
  typedef PSOCKET_ADDRESS LPSOCKET_ADDRESS*;
  ...
  typedef WSANAMESPACE_INFOEX LPWSANAMESPACE_INFOEX;
  ...
  typedef WSANSCLASSINFO LPWSANSCLASSINFO;
  ...
  typedef WSASERVICECLASSINFO LPWSASERVICECLASSINFO;
  ...
  typedef DWORD WINAPI_SocketOption;
  typedef DWORD WINAPI_SendRecvFlags;
  typedef UINT WINAPI_NI_Flags;
  ...
  typedef DWORD WINAPI_NameSpaceFlags;
  typedef DWORD WINAPI_ResolutionFlags;
  typedef DWORD WINAPI_GetService_Props;
  typedef DWORD WINAPI_SetService_Operation;
  typedef DWORD WINAPI_SetService_Flags;
  typedef DWORD WINAPI_SetService_FlagsOut;
  typedef DWORD WINAPI_TransmitFile_Flags;
