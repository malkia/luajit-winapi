...
# pragma pack( pop )
  ...
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_PARENT_PROCESS = 0x00020000;
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_EXTENDED_FLAGS = 0x00060001;
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_HANDLE_LIST = 0x00020002;
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_IDEAL_PROCESSOR = 0x00030005;
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_MITIGATION_POLICY = 0x00020007;
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_PREFERRED_NODE = 0x00020004;
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_UMS_THREAD = 0x00030006;
  static const WINAPI_ProcThreadAttribute PROC_THREAD_ATTRIBUTE_GROUP_AFFINITY = 0x00030003;
