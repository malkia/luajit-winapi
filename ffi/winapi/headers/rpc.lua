...
ffi.cdef [[
  ...
  typedef LPTSTR RPC_TSTR;
  typedef void* RPC_IF_HANDLE;
  typedef void* RPC_NS_HANDLE;
  typedef void* RPC_AUTHZ_HANDLE;
  typedef void* RPC_AUTH_IDENTITY_HANDLE;
  typedef void* RPC_EP_INQ_HANDLE;
  typedef LPVOID RPC_CLIENT_ALLOC*;
  typedef LPVOID RPC_CLIENT_FREE*;
  typedef LPVOID RPC_MGMT_AUTHORIZATION_FN;
  typedef LPVOID RPC_OBJECT_INQ_FN;
  typedef void* RPC_MGR_EPV*;
  typedef LPVOID RPC_AUTH_KEY_RETRIEVAL_FN;
  typedef LPVOID RPC_IF_CALLBACK_FN*;
  typedef void* RPC_SS_THREAD_HANDLE;
  typedef LPVOID PFN_RPCNOTIFICATION_ROUTINE;
  ...
  typedef unsigned long WINAPI_RPC_BHT;
  ...
  typedef unsigned long WINAPI_RPC_C_QOS_CAPABILITIES;
  ...
  typedef unsigned long WINAPI_SEC_WINNT_AUTH_IDENTITY;
  ...
  typedef unsigned long WINAPI_RPC_BHO;
  ...
  typedef unsigned long WINAPI_RPC_POLICY_EndPoint;
  typedef unsigned long WINAPI_RPC_POLICY_Nic;
  ...
  typedef WINAPI_RPC_C_AUTHN_LEVEL WINAPI_RPC_C_AUTHN_LEVEL_unsigned_int;
  ...
  typedef USHORT WINAPI_RPC_EE_FLAGS;
  ...
  typedef unsigned long WINAPI_RPC_ASYNC_STATE_FLAGS;
