...
ffi.cdef [[
  ...
  BOOL_ULONG   FBadColumnSet(              LPSPropTagArray lpptaCols);
  BOOL         FBadEntryList(              LPENTRYLIST lpEntryList);
  BOOL_ULONG   FBadProp(                   LPSPropValue lpprop);
  BOOL_ULONG   FBadPropTag(                ULONG ulPropTag);
  BOOL_ULONG   FBadRestriction(            LPSRestriction lpres);
  BOOL         FBadRglpNameID(             LPMAPINAMEID* lppNameId, ULONG cNames);
  BOOL         FBadRglpszW(                LPWSTR* lppszW, ULONG cStrings);
  BOOL_ULONG   FBadRow(                    LPSRow lprow);
  BOOL         FBadRowSet(                 LPSRowSet lpRowSet);
  BOOL_ULONG   FBadSortOrderSet(           LPSSortOrderSet lpsos);
