...
ffi.cdef [[
  ...
  static const UINT NET_FW_IP_VERSION_V4 = 0;
  static const UINT NET_FW_IP_VERSION_V6 = 1;
  static const UINT NET_FW_IP_VERSION_ANY = 2;
  typedef UINT NET_FW_SCOPE; //Alias
  static const UINT NET_FW_SCOPE_ALL = 0;
  static const UINT NET_FW_SCOPE_LOCAL_SUBNET = 1;
  static const UINT NET_FW_SCOPE_CUSTOM = 2;
  typedef UINT NET_FW_PROFILE_TYPE; //Alias
  static const UINT NET_FW_PROFILE_DOMAIN = 0;
  static const UINT NET_FW_PROFILE_STANDARD = 1;
  static const UINT NET_FW_PROFILE_CURRENT = 2;
  typedef UINT NET_FW_IP_PROTOCOL; //Alias
  static const UINT NET_FW_IP_PROTOCOL_TCP = 6;
  static const UINT NET_FW_IP_PROTOCOL_UDP = 17;
  static const UINT NET_FW_IP_PROTOCOL_ANY = 256;
  typedef UINT NET_FW_PROFILE_TYPE2; //Alias
  typedef UINT NET_FW_MODIFY_STATE; //Alias
  static const UINT NET_FW_MODIFY_STATE_OK = 0;
  static const UINT NET_FW_MODIFY_STATE_GP_OVERRIDE = 1;
  static const UINT NET_FW_MODIFY_STATE_INBOUND_BLOCKED = 2;
  typedef UINT NET_FW_RULE_DIRECTION; //Alias
  static const UINT NET_FW_RULE_DIR_IN = 1;
  static const UINT NET_FW_RULE_DIR_OUT = 2;
  typedef UINT NET_FW_ACTION; //Alias
  static const UINT NET_FW_ACTION_BLOCK = 0;
  static const UINT NET_FW_ACTION_ALLOW = 1;
  typedef UINT NET_FW_SERVICE_TYPE; //Alias
  static const UINT NET_FW_SERVICE_FILE_AND_PRINT = 0;
  static const UINT NET_FW_SERVICE_UPNP = 1;
  static const UINT NET_FW_SERVICE_REMOTE_DESKTOP = 2;
  static const UINT NET_FW_SERVICE_NONE = 3;
]]
