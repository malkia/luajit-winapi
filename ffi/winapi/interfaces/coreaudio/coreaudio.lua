...
ffi.cdef [[
  ...
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_NOT_INITIALIZED = 0x88890001;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_ALREADY_INITIALIZED = 0x88890002;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_WRONG_ENDPOINT_TYPE = 0x88890003;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_DEVICE_INVALIDATED = 0x88890004;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_NOT_STOPPED = 0x88890005;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_BUFFER_TOO_LARGE = 0x88890006;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_OUT_OF_ORDER = 0x88890007;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_UNSUPPORTED_FORMAT = 0x88890008;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_INVALID_SIZE = 0x88890009;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_DEVICE_IN_USE = 0x8889000a;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_BUFFER_OPERATION_PENDING = 0x8889000b;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_THREAD_NOT_REGISTERED = 0x8889000c;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_EXCLUSIVE_MODE_NOT_ALLOWED = 0x8889000e;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_ENDPOINT_CREATE_FAILED = 0x8889000f;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_SERVICE_NOT_RUNNING = 0x88890010;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_EVENTHANDLE_NOT_EXPECTED = 0x88890011;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_EXCLUSIVE_MODE_ONLY = 0x88890012;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_BUFDURATION_PERIOD_NOT_EQUAL = 0x88890013;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_EVENTHANDLE_NOT_SET = 0x88890014;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_INCORRECT_BUFFER_SIZE = 0x88890015;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_BUFFER_SIZE_ERROR = 0x88890016;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_CPUUSAGE_EXCEEDED = 0x88890017;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_BUFFER_ERROR = 0x88890018;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_BUFFER_SIZE_NOT_ALIGNED = 0x88890019;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_E_INVALID_DEVICE_PERIOD = 0x88890020;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_S_BUFFER_EMPTY = 0x08890001;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_S_THREAD_ALREADY_REGISTERED = 0x08890002;
  static const WINAPI_AUDCLNT_HRESULT AUDCLNT_S_POSITION_STALLED = 0x08890003;
