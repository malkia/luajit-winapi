...
ffi.cdef [[
  ...
  static const UINT SYNCMGR_EL_INFORMATION = 1;
  static const UINT SYNCMGR_EL_WARNING = 2;
  static const UINT SYNCMGR_EL_ERROR = 3;
  typedef UINT SYNCMGR_CANCEL_REQUEST; //Alias
  static const UINT SYNCMGR_CR_NONE = 0;
  static const UINT SYNCMGR_CR_CANCEL_ITEM = 1;
  static const UINT SYNCMGR_CR_CANCEL_ALL = 2;
  typedef UINT SYNCMGR_PROGRESS_STATUS; //Alias
  static const UINT SYNCMGR_PS_UPDATING = 1;
  static const UINT SYNCMGR_PS_UPDATING_INDETERMINATE = 2;
  static const UINT SYNCMGR_PS_SUCCEEDED = 3;
  static const UINT SYNCMGR_PS_FAILED = 4;
  static const UINT SYNCMGR_PS_CANCELED = 5;
  static const UINT SYNCMGR_PS_DISCONNECTED = 6;
  typedef UINT SYNCMGR_RESOLUTION_FEEDBACK; //Alias
  static const UINT SYNCMGR_RF_CONTINUE = 0;
  static const UINT SYNCMGR_RF_REFRESH = 1;
  static const UINT SYNCMGR_RF_CANCEL = 2;
  typedef UINT SYNCMGR_HANDLER_TYPE; //Alias
  static const UINT SYNCMGR_HT_UNSPECIFIED = 0;
  static const UINT SYNCMGR_HT_APPLICATION = 1;
  static const UINT SYNCMGR_HT_DEVICE = 2;
  static const UINT SYNCMGR_HT_FOLDER = 3;
  static const UINT SYNCMGR_HT_SERVICE = 4;
  static const UINT SYNCMGR_HT_COMPUTER = 5;
  typedef UINT SYNCMGR_UPDATE_REASON; //Alias
  static const UINT SYNCMGR_UR_ADDED = 0;
  static const UINT SYNCMGR_UR_CHANGED = 1;
  static const UINT SYNCMGR_UR_REMOVED = 2;
  typedef UINT SYNCMGR_PRESENTER_CHOICE; //Alias
  static const UINT SYNCMGR_PC_NO_CHOICE = 0;
  static const UINT SYNCMGR_PC_KEEP_ONE = 1;
  static const UINT SYNCMGR_PC_KEEP_MULTIPLE = 2;
  static const UINT SYNCMGR_PC_KEEP_RECENT = 3;
  static const UINT SYNCMGR_PC_REMOVE_FROM_SYNC_SET = 4;
  static const UINT SYNCMGR_PC_SKIP = 5;
  typedef UINT SYNCMGR_PRESENTER_NEXT_STEP; //Alias
  static const UINT SYNCMGR_PNS_CONTINUE = 0;
  static const UINT SYNCMGR_PNS_DEFAULT = 1;
  static const UINT SYNCMGR_PNS_CANCEL = 2;
  typedef struct CONFIRM_CONFLICT_RESULT_INFO {
    LPWSTR pszNewName;
    UINT iItemIndex;
  } CONFIRM_CONFLICT_RESULT_INFO;
  typedef UINT SYNCMGR_CONFLICT_ITEM_TYPE; //Alias
  static const UINT SYNCMGR_CIT_UPDATED = 0x1;
  static const UINT SYNCMGR_CIT_DELETED = 0x2;
