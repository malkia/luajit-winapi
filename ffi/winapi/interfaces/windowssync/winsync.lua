...
ffi.cdef [[
  ...
  static const UINT CRP_NONE = 0;
  static const UINT CRP_DESTINATION_PROVIDER_WINS = 1;
  static const UINT CRP_SOURCE_PROVIDER_WINS = 2;
  typedef UINT FILTERING_TYPE; //Alias
  static const UINT FT_CURRENT_ITEMS_ONLY = 0;
  typedef UINT KNOWLEDGE_COOKIE_COMPARISON_RESULT; //Alias
  static const UINT KCCR_COOKIE_KNOWLEDGE_EQUAL = 0;
  static const UINT KCCR_COOKIE_KNOWLEDGE_CONTAINED = 1;
  static const UINT KCCR_COOKIE_KNOWLEDGE_CONTAINS = 2;
  static const UINT KCCR_COOKIE_KNOWLEDGE_NOT_COMPARABLE = 3;
  typedef UINT SYNC_FULL_ENUMERATION_ACTION; //Alias
  static const UINT SFEA_FULL_ENUMERATION = 0;
  static const UINT SFEA_PARTIAL_SYNC = 1;
  static const UINT SFEA_ABORT = 2;
  typedef UINT SYNC_PROGRESS_STAGE; //Alias
  static const UINT SPS_CHANGE_DETECTION = 0;
  static const UINT SPS_CHANGE_ENUMERATION = 1;
  static const UINT SPS_CHANGE_APPLICATION = 2;
  typedef UINT SYNC_PROVIDER_ROLE; //Alias
  static const UINT SPR_SOURCE = 0;
  static const UINT SPR_DESTINATION = 1;
  typedef UINT SYNC_RESOLVE_ACTION; //Alias
  static const UINT SRA_DEFER = 0;
  static const UINT SRA_ACCEPT_DESTINATION_PROVIDER = 1;
  static const UINT SRA_ACCEPT_SOURCE_PROVIDER = 2;
  static const UINT SRA_MERGE = 3;
  static const UINT SRA_TRANSFER_AND_DEFER = 4;
  typedef UINT SYNC_SERIALIZATION_VERSION; //Alias
  static const UINT SYNC_SERIALIZATION_VERSION_V1 = 1;
  static const UINT SYNC_SERIALIZATION_VERSION_V2 = 4;
  typedef UINT SYNC_STATISTICS; //Alias
  static const UINT SYNC_STATISTICS_RANGE_COUNT = 0;
