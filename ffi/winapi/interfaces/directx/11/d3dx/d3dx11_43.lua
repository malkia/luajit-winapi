...
ffi.cdef [[
  HRESULT D3DX11CompileFromFile(                        LPCTSTR pSrcFile, WINAPI_D3D10_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, WINAPI_D3D10_SHADER Flags1, WINAPI_D3D10_EFFECT Flags2, ID3DX11ThreadPump* pPump, ID3D10Blob** ppShader, ID3D10Blob** ppErrorMsgs, HRESULT* pHResult);
  HRESULT D3DX11CompileFromMemory(                      LPCSTR pSrcData, SIZE_T SrcDataLen, LPCSTR pFileName, WINAPI_D3D10_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, ID3DX11ThreadPump* pPump, ID3D10Blob** ppShader, ID3D10Blob** ppErrorMsgs, HRESULT* pHResult);
  HRESULT D3DX11CompileFromResource(                    HMODULE hSrcModule, LPCTSTR pSrcResource, LPCTSTR pSrcFileName, WINAPI_D3D10_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, ID3DX11ThreadPump* pPump, ID3D10Blob** ppShader, ID3D10Blob** ppErrorMsgs, HRESULT* pHResult);
  ...
  HRESULT D3DX11CreateAsyncCompilerProcessor(           LPCSTR pFileName, WINAPI_D3D11_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, UINT Flags1, UINT Flags2, ID3D10Blob** ppCompiledShader, ID3D10Blob** ppErrorBuffer, ID3DX11DataProcessor** ppDataProcessor);
  ...
  HRESULT D3DX11CreateAsyncShaderPreprocessProcessor(   LPCSTR pFileName, WINAPI_D3D11_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, ID3D10Blob** ppShaderText, ID3D10Blob** ppErrorBuffer, ID3DX11DataProcessor** ppDataProcessor);
  ...
  HRESULT D3DX11PreprocessShaderFromFile(               LPCTSTR pFileName, WINAPI_D3D11_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, ID3DX11ThreadPump* pPump, ID3D10Blob** ppShaderText, ID3D10Blob** ppErrorMsgs, HRESULT* pHResult);
  HRESULT D3DX11PreprocessShaderFromMemory(             LPCSTR pSrcData, SIZE_T SrcDataSize, LPCSTR pFileName, WINAPI_D3D11_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, ID3DX11ThreadPump* pPump, ID3D10Blob** ppShaderText, ID3D10Blob** ppErrorMsgs, HRESULT* pHResult);
  HRESULT D3DX11PreprocessShaderFromResource(           HMODULE hModule, LPCTSTR pResourceName, LPCTSTR pSrcFileName, WINAPI_D3D11_SHADER_MACRO* pDefines, LPD3D10INCLUDE pInclude, ID3DX11ThreadPump* pPump, ID3D10Blob** ppShaderText, ID3D10Blob** ppErrorMsgs, HRESULT* pHResult);
