...
ffi.cdef [[
  ...
  HRESULT D3DX11CreateFFT(           ID3D11DeviceContext* pDeviceContext, D3DX11_FFT_DESC* pDesc, D3DX11_FFT_CREATE_FLAG Flags, D3DX11_FFT_BUFFER_INFO* pBufferInfo, ID3DX11FFT** ppFFT);
