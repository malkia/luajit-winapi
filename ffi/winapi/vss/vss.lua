...
//typedef LPVOID CVssWriterEx*; //Alias
  ...
  typedef VSS_ID *const VSS_ID*; //Pointer
  typedef WCHAR* VSS_PWSZ; //Alias
  typedef LONGLONG VSS_TIMESTAMP; //Alias
  typedef HRESULT WINAPI_VSS_HRESULT; //Alias
  static const WINAPI_VSS_HRESULT VSS_E_BAD_STATE = 0x80042301;
  static const WINAPI_VSS_HRESULT VSS_E_UNEXPECTED = 0x80042302;
  static const WINAPI_VSS_HRESULT VSS_E_PROVIDER_ALREADY_REGISTERED = 0x80042303;
  static const WINAPI_VSS_HRESULT VSS_E_PROVIDER_NOT_REGISTERED = 0x80042304;
  static const WINAPI_VSS_HRESULT VSS_E_PROVIDER_VETO = 0x80042306;
  static const WINAPI_VSS_HRESULT VSS_E_PROVIDER_IN_USE = 0x80042307;
  static const WINAPI_VSS_HRESULT VSS_E_OBJECT_NOT_FOUND = 0x80042308;
  static const WINAPI_VSS_HRESULT VSS_S_ASYNC_PENDING = 0x00042309;
  static const WINAPI_VSS_HRESULT VSS_S_ASYNC_FINISHED = 0x0004230A;
  static const WINAPI_VSS_HRESULT VSS_S_ASYNC_CANCELLED = 0x0004230B;
  static const WINAPI_VSS_HRESULT VSS_E_VOLUME_NOT_SUPPORTED = 0x8004230C;
  static const WINAPI_VSS_HRESULT VSS_E_VOLUME_NOT_SUPPORTED_BY_PROVIDER = 0x8004230E;
  static const WINAPI_VSS_HRESULT VSS_E_OBJECT_ALREADY_EXISTS = 0x8004230D;
  static const WINAPI_VSS_HRESULT VSS_E_UNEXPECTED_PROVIDER_ERROR = 0x8004230F;
  static const WINAPI_VSS_HRESULT VSS_E_CORRUPT_XML_DOCUMENT = 0x80042310;
  static const WINAPI_VSS_HRESULT VSS_E_INVALID_XML_DOCUMENT = 0x80042311;
  static const WINAPI_VSS_HRESULT VSS_E_MAXIMUM_NUMBER_OF_VOLUMES_REACHED = 0x80042312;
  static const WINAPI_VSS_HRESULT VSS_E_FLUSH_WRITES_TIMEOUT = 0x80042313;
  static const WINAPI_VSS_HRESULT VSS_E_HOLD_WRITES_TIMEOUT = 0x80042314;
  static const WINAPI_VSS_HRESULT VSS_E_UNEXPECTED_WRITER_ERROR = 0x80042315;
  static const WINAPI_VSS_HRESULT VSS_E_SNAPSHOT_SET_IN_PROGRESS = 0x80042316;
  static const WINAPI_VSS_HRESULT VSS_E_MAXIMUM_NUMBER_OF_SNAPSHOTS_REACHED = 0x80042317;
  static const WINAPI_VSS_HRESULT VSS_E_WRITER_INFRASTRUCTURE = 0x80042318;
  static const WINAPI_VSS_HRESULT VSS_E_WRITER_NOT_RESPONDING = 0x80042319;
  static const WINAPI_VSS_HRESULT VSS_E_WRITER_ALREADY_SUBSCRIBED = 0x8004231A;
  static const WINAPI_VSS_HRESULT VSS_E_UNSUPPORTED_CONTEXT = 0x8004231B;
  static const WINAPI_VSS_HRESULT VSS_E_VOLUME_IN_USE = 0x8004231D;
  static const WINAPI_VSS_HRESULT VSS_E_MAXIMUM_DIFFAREA_ASSOCIATIONS_REACHED = 0x8004231E;
  static const WINAPI_VSS_HRESULT VSS_E_INSUFFICIENT_STORAGE = 0x8004231F;
  static const WINAPI_VSS_HRESULT VSS_E_NO_SNAPSHOTS_IMPORTED = 0x80042320;
  static const WINAPI_VSS_HRESULT VSS_S_SOME_SNAPSHOTS_NOT_IMPORTED = 0x00042321;
  static const WINAPI_VSS_HRESULT VSS_E_SOME_SNAPSHOTS_NOT_IMPORTED = 0x80042321;
  static const WINAPI_VSS_HRESULT VSS_E_MAXIMUM_NUMBER_OF_REMOTE_MACHINES_REACHED = 0x80042322;
  static const WINAPI_VSS_HRESULT VSS_E_REMOTE_SERVER_UNAVAILABLE = 0x80042323;
  static const WINAPI_VSS_HRESULT VSS_E_REMOTE_SERVER_UNSUPPORTED = 0x80042324;
  static const WINAPI_VSS_HRESULT VSS_E_REVERT_IN_PROGRESS = 0x80042325;
  static const WINAPI_VSS_HRESULT VSS_E_REVERT_VOLUME_LOST = 0x80042326;
  static const WINAPI_VSS_HRESULT VSS_E_REBOOT_REQUIRED = 0x80042327;
  static const WINAPI_VSS_HRESULT VSS_E_TRANSACTION_FREEZE_TIMEOUT = 0x80042328;
  static const WINAPI_VSS_HRESULT VSS_E_TRANSACTION_THAW_TIMEOUT = 0x80042329;
  static const WINAPI_VSS_HRESULT VSS_E_VOLUME_NOT_LOCAL = 0x8004232D;
  static const WINAPI_VSS_HRESULT VSS_E_CLUSTER_TIMEOUT = 0x8004232E;
  static const WINAPI_VSS_HRESULT VSS_E_WRITERERROR_INCONSISTENTSNAPSHOT = 0x800423F0;
  static const WINAPI_VSS_HRESULT VSS_E_WRITERERROR_OUTOFRESOURCES = 0x800423F1;
  static const WINAPI_VSS_HRESULT VSS_E_WRITERERROR_TIMEOUT = 0x800423F2;
  static const WINAPI_VSS_HRESULT VSS_E_WRITERERROR_RETRYABLE = 0x800423F3;
  static const WINAPI_VSS_HRESULT VSS_E_WRITERERROR_NONRETRYABLE = 0x800423F4;
  static const WINAPI_VSS_HRESULT VSS_E_WRITERERROR_RECOVERY_FAILED = 0x800423F5;
  static const WINAPI_VSS_HRESULT VSS_E_BREAK_REVERT_ID_FAILED = 0x800423F6;
  static const WINAPI_VSS_HRESULT VSS_E_LEGACY_PROVIDER = 0x800423F7;
  static const WINAPI_VSS_HRESULT VSS_E_MISSING_DISK = 0x800423F8;
  static const WINAPI_VSS_HRESULT VSS_E_MISSING_HIDDEN_VOLUME = 0x800423F9;
  static const WINAPI_VSS_HRESULT VSS_E_MISSING_VOLUME = 0x800423FA;
  static const WINAPI_VSS_HRESULT VSS_E_AUTORECOVERY_FAILED = 0x800423FB;
  static const WINAPI_VSS_HRESULT VSS_E_DYNAMIC_DISK_ERROR = 0x800423FC;
  static const WINAPI_VSS_HRESULT VSS_E_NONTRANSPORTABLE_BCD = 0x800423FD;
  static const WINAPI_VSS_HRESULT VSS_E_CANNOT_REVERT_DISKID = 0x800423FE;
  static const WINAPI_VSS_HRESULT VSS_E_RESYNC_IN_PROGRESS = 0x800423FF;
  static const WINAPI_VSS_HRESULT VSS_E_CLUSTER_ERROR = 0x80042400;
  static const WINAPI_VSS_HRESULT VSS_E_UNSELECTED_VOLUME = 0x8004232A;
  static const WINAPI_VSS_HRESULT VSS_E_SNAPSHOT_NOT_IN_SET = 0x8004232B;
  static const WINAPI_VSS_HRESULT VSS_E_NESTED_VOLUME_LIMIT = 0x8004232C;
  static const WINAPI_VSS_HRESULT VSS_E_NOT_SUPPORTED = 0x8004232F;
  static const WINAPI_VSS_HRESULT VSS_E_WRITERERROR_PARTIAL_FAILURE = 0x80042336;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_DISK_ASSIGNMENT_FAILED = 0x80042401;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_DISK_RECREATION_FAILED = 0x80042402;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_NO_ARCPATH = 0x80042403;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_MISSING_DYNDISK = 0x80042404;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_SHARED_CRIDISK = 0x80042405;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_DATADISK_RDISK0 = 0x80042406;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_RDISK0_TOOSMALL = 0x80042407;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_CRITICAL_DISKS_TOO_SMALL = 0x80042408;
  static const WINAPI_VSS_HRESULT VSS_E_WRITER_STATUS_NOT_AVAILABLE = 0x80042409;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_DYNAMIC_VHD_NOT_SUPPORTED = 0x8004240A;
  static const WINAPI_VSS_HRESULT VSS_E_CRITICAL_VOLUME_ON_INVALID_DISK = 0x80042411;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_RDISK_FOR_SYSTEM_DISK_NOT_FOUND = 0x80042412;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_NO_PHYSICAL_DISK_AVAILABLE = 0x80042413;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_FIXED_PHYSICAL_DISK_AVAILABLE_AFTER_DISK_EXCLUSION = 0x80042414;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_CRITICAL_DISK_CANNOT_BE_EXCLUDED = 0x80042415;
  static const WINAPI_VSS_HRESULT VSS_E_ASRERROR_SYSTEM_PARTITION_HIDDEN = 0x80042416;
